<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OvertimePreOrder.aspx.cs"
    Inherits="OverTime_OvertimePreOrder" %>
...
//    }
    ...
    function funYesOrNoUpdateDeclara(msg) {
        if (confirm(msg)) {
            document.getElementById('CancelUpdateDecla').click();
        }
    }
</script>
<body>
    ...
    <fieldset class="Util_Fieldset">
        <legend class="Util_Legend">預先申請</legend>
                    ...
                    <table width="100%" cellpadding="1" cellspacing="1">
                        <tr style="height: 20px">
                            <td colspan="3" align="left">
                                ...
                                <asp:Button ID="btnSubmitInvisible" runat="server" Text="送簽" CssClass="Util_clsBtn"
                                    Style="display: none;" OnClick="btnSubmitInvisible_Click" />
                                ...
                                <asp:Button ID="btnCancelInvisible" runat="server" Text="取消" CssClass="Util_clsBtn"
                                    Style="display: none;" OnClick="btnCancelInvisible_Click" />
                                <asp:Button ID="CancelUpdateDecla" runat="server" Text="" CssClass="Util_clsBtn" onclick="CancelUpdateDecla_Click" Style="display: none;"/>
                                <asp:Button ID="Button1" runat="server" Text="" CssClass="Util_clsBtn" onclick="CancelUpdateDecla_Click" Style="display: none;"/>
                        ...
                        <tr style="height: 20px" class="Util_clsRow1">
                            <td width="30%" align="left">
                                ...
                                <%--<asp:Label ID="lblOTCompID" runat="server" Text="公司代碼"></asp:Label>&nbsp;&nbsp;--%>
                                <asp:Label ID="lblOTCompName" runat="server"></asp:Label>
                                <%--<asp:DropDownList ID="ddlOTCompName" runat="server">
                                </asp:DropDownList>--%>
                            </td>
                            <td style="width: 30%" align="left">
                                <asp:Label ID="lblDept" runat="server" Text="單位："></asp:Label>
                                <%--<asp:Label ID="lblDeptID" runat="server" Text="單位代碼"></asp:Label>&nbsp;&nbsp;--%>
                                <asp:Label ID="lblDeptName" runat="server"></asp:Label>
                            </td>
                            <td width="30%" align="left">
                                <asp:Label ID="lblOrgan" runat="server" Text="科別："></asp:Label>
                                <%--<asp:Label ID="lblOrganID" runat="server" Text="科別代碼"></asp:Label>&nbsp;&nbsp;--%>
                        ...
                        <tr style="height: 20px" class="Util_clsRow1" id="trQuery" runat="server">
                            <td width="30%" align="left">
                                ...
                                <asp:DropDownList ID="ddlQueryConditions" runat="server" Style="font-family: '微軟正黑體', '微软雅黑', 'Microsoft JhengHei', 'Arial, sans-serif';"
                                    Width="170px">
                        ...
                        <tr style="height: 20px" class="Util_clsRow2" id="trQuery2" runat="server">
                            ...
                            <td style="width: 30%" align="left">
                                ...
                                <asp:DropDownList ID="ddlOTStatus" runat="server" Style="font-family: '微軟正黑體', '微软雅黑', 'Microsoft JhengHei', 'Arial, sans-serif';"
                                    Width="170px">
                                    <asp:ListItem Value="0" Text="----請選擇----"></asp:ListItem>
    ...
    <div style="height: 75%; width: 100%; overflow: auto;">
        <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" DataKeyNames="OTCompID, OTEmpID, OTDate,OTTime,OTStatusName,OTTotalTime,OTTxnID,OTStatus,OTFormNO,FlowCaseID"
            AllowPaging="false" OnRowDataBound="gvMain_RowDataBound" OnRowCommand="gvMain_RowCommand"
            Width="100%">
            <Columns>
                ...
                <asp:BoundField HeaderText="表單編號" ItemStyle-Width="1px" ItemStyle-Wrap="true" SortExpression="OTFormNO"
                    DataField="OTFormNO" HtmlEncode="false">
