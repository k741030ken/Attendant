<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AfterOvertimeOrder_Add.aspx.cs" Inherits="OverTime_AfterOvertimeOrder_Add" %>
...
<body>
    ...
    <legend class="Util_Legend">事後申報-新增</legend>
            ...
            <td align="left">
                <table width="100%" cellpadding="1" cellspacing="1">
                    ...
                    <tr style="height:20px" class="Util_clsRow1">
                        ...
                        <td style="width:35%" align="left">                                
                            ...
                            <asp:Label ID="lblCompID" runat="server" style="display:none;" ></asp:Label>    
                        </td>
                        <td width="10%" align="left">
                            <asp:Label ID="lblDept" runat="server" Text="*單位：" ForeColor="Blue"></asp:Label>
                        </td>
                        <td style="width:35%" align="left">                    
                            <asp:Label ID="lblDeptID" runat="server" style="display:none;" ></asp:Label>        
                    ...
                    <tr style="height:20px" class="Util_clsRow2">
                        ...
                        <td style="width:35%" align="left">
                            <asp:Label ID="lblOrganID" runat="server" style="display:none;" ></asp:Label>                                     
                    ...
                    <tr style="height:20px" class="Util_clsRow1">
                        ...
                        <td width="45%" align="left">
                            ...
                            <asp:Label ID="txtAdjustInvalidDate" runat="server" Text="" Visible="false"></asp:Label><%--Visible="false"--%>
                        </td>
                        </tr>
                    <tr style="height:20px" class="Util_clsRow2">
                        <td width="10%" align="left">
                        ...
                        <td style="width:35%" align="left" colspan="3">                                
                            <asp:ucDate ID="ucDateStart" runat="server" CssClass="InputTextStyle_Thin" Enabled="True" Width="80px" AutoPostBack="true" />
                            <asp:Label ID="Label4" runat="server" Text="~"></asp:Label>
                            <asp:ucDate ID="ucDateEnd" runat="server" CssClass="InputTextStyle_Thin" Enabled="True" Width="80px" AutoPostBack="true" />
                        </td>
                    </tr>
                    <tr style="height:20px" class="Util_clsRow1">
                        <td width="10%" align="left">
                ...
                <div style ="height:75%; width:100%; overflow:auto; ">
                    <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" 
                        CellPadding="2" DataKeyNames="OTCompID,OTFormNO,OTEmpID,OTDate,OTTime,OTTotalTime,OTTxnID,OTFromAdvanceTxnId" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray" Visible="false" onrowdatabound="gvMain_RowDataBound">
