<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OvertimePreOrder_Detail.aspx.cs" Inherits="OverTime_OvertimePreOrder_Detail" %>
...
<body>
    ...
    <table style="width:100%;border:1px solid" rules="all">
        ...
        <tr class="Util_clsRow1">
            ...
            <td colspan="2">
                <asp:Label ID="lblSalaryOrAdjustWay" runat="server" Text="*加班轉換方式：" 
                    ForeColor="Blue"></asp:Label>
                <asp:Label ID="lblSalaryOrAdjust" runat="server"></asp:Label>&nbsp;&nbsp;
                <asp:Label ID="lblAdjustInvalidDate" runat="server" Text="補休失效日：" 
            ...
            <td colspan="2">
                ...
                <table width="60%" align="left" id="tbTime" visible="False" style="border: 1px solid black;" runat="server" rules="all" >
                    <tr align="center" runat="server">
                                <td width="25%" rowspan="2" runat="server">日期</td>
                                <td width="25%" colspan="3" runat="server">小時</td>
                            </tr>
                            <tr align="center" runat="server">
                                <td width="25%" runat="server">時段(一)</td>
                                <td width="25%" runat="server">時段(二)</td>
                                <td width="25%" runat="server">時段(三)</td>
                            </tr> 
                    <tr id="trOne" visible="False" runat="server" align="center">
                        <td runat="server"><asp:Label ID="lblDateOne" runat="server" ></asp:Label></td>
                        <td runat="server"><asp:Label ID="lblDateOne_0" runat="server" ></asp:Label></td>
                        <td runat="server"><asp:Label ID="lblDateOne_1" runat="server" ></asp:Label></td>
                        <td runat="server"><asp:Label ID="lblDateOne_2" runat="server" ></asp:Label></td>
                    </tr>
                    <tr id="trTwo" visible="False" runat="server" align="center">
                        <td runat="server"><asp:Label ID="lblDateTwo" runat="server" ></asp:Label></td>
                        <td runat="server"><asp:Label ID="lblDateTwo_0" runat="server" ></asp:Label></td>
                        <td runat="server"><asp:Label ID="lblDateTwo_1" runat="server" ></asp:Label></td>
                        <td runat="server"><asp:Label ID="lblDateTwo_2" runat="server" ></asp:Label></td>
                    </tr>
                </table>
            </td>
