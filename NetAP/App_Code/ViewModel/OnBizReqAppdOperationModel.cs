...
/// <summary>
/// OnBizReqAppdOperationModel 的摘要描述
/// </summary>
public class OnBizReqAppdOperationModel
{
    /// <summary>
    /// 人員公司ID
    /// </summary>
    ...
    /// Grid Data(List)
    /// </summary>
    public List<CheckVisitGridDataModel> CheckVisitGridDataList { get; set; }

    /// <summary>
    /// Grid Data(List)
    /// </summary>
    public List<CheckVisitPKModel> CheckVisitPKModelList { get; set; }

}

public class CheckVisitGridDataModel //請取有意義的名稱+Model結尾
{
    /// <summary>
    /// 公出人員公司
    /// </summary>
