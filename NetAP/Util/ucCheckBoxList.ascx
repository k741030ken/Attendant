...
<div style="display: inline-block; vertical-align: top; *display: inline; *zoom: 1;">
    ...
    </span><span id="divDataArea" runat="server" style="position: relative; top: 0px; vertical-align: top;">
                ...
                <asp:Panel ID="pnlBoxList" runat="server" CssClass="Util_clsShadow">
                    ...
                    <div id="divButtonArea" runat="server">
                        ...
                        <div id="divSelect" runat="server" style="float:left;width: 100%; display: inline-block; padding: 1px; text-align: center; vertical-align: top; *display: inline; *zoom: 1;">
                            <asp:Button ID="btnAll" runat="server" CausesValidation="false" CssClass="Util_clsBtnGray"
                                Width="48%" Text="All" />
