...
public partial class Util_ucCommUserAdminButton : BaseUserControl
{
    ...
    public string ucPopupHeader
    {
        get
        {
            ...
            {
                PageViewState["_PopupHeader"] = RS.Resources.CommUser_PopHeader;
            }
    ...
    public string ucBtnCaption
    {
        get
        {
            ...
            {
                PageViewState["_BtnCaption"] = RS.Resources.CommUser_btnLaunch;
            }
    ...
    public int ucPopupHeight
    {
        get
        {
            ...
            {
                PageViewState["_PopupHeight"] = 450;
            }
    ...
    protected void btnLaunch_Click(object sender, EventArgs e)
    {
        ...
        if (oUser == null)
        {
            Util.NotifyMsg(RS.Resources.CommUser_SessionNotFound, Util.NotifyKind.Error);
            return;
        }
        ...
        ucModalPopup1.ucFrameURL = Util._CommUserAdminUrl;
