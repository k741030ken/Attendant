<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AclAdminRuleArea.aspx.cs" Inherits="AclExpress_Admin_AclAdminRuleArea" %>
        ...
        <div>
            ...
            <div id="DivMainList" runat="server">
                <fieldset class="Util_Fieldset">
                    <legend class="Util_Legend">規則管理類型清單</legend>
                    <%--主檔列表--%>
            ...
            <div id="DivMainSingle" runat="server" style="width: 100%;">
                <fieldset class='Util_Fieldset'>
                    <legend class="Util_Legend">規則管理類型</legend>
                    <%--主檔表單--%>
                    <asp:FormView ID="fmMain" runat="server" OnDataBound="fmMain_DataBound" CssClass="Util_CenterBody">
                        <InsertItemTemplate>
                            ...
                            <div class="Util_clsRow1" style="padding: 3px;">
                                <uc1:ucCommSingleSelect ID="RuleID" runat="server" ucCaption="規則代號" ucIsSearchEnabled="false" ucIsRequire="true" ucDropDownSourceListWidth="150" />
                            </div>
            ...
            <div id="DivDetailArea" runat="server">
                <fieldset class='Util_Fieldset'>
                    <legend class="Util_Legend">規則管理項目清單</legend>
