<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SC0242.aspx.vb" Inherits="SC_SC0242" %>
                ...
                <td align="center">
                    <table width="80%" class="tbl_Edit" cellpadding="1" cellspacing="1">
                        <tr style="height:20px">
                            <td class="td_EditHeader" width="30%" align="center"><asp:Label ID="lblFunID_H" ForeColor="Blue" runat="server" Text="*功能代码"></asp:Label>
                            </td>
                            <td class="td_Edit" style="width:70%" align="left"><asp:Label ID="lblFunID" ForeColor="blue" Font-Bold="true" CssClass="InputTextStyle_Thin" runat="server" Width="115px" ></asp:Label>
                            </td>
                        </tr>
                        <tr style="height:20px">
