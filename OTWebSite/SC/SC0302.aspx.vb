...
Partial Class SC_SC0302
    ...
    Protected Overrides Sub BaseOnPageTransfer(ByVal ti As TransferInfo)
        If Not IsPostBack() Then
            ...
            If ht.ContainsKey("SelectedFunID") Then
                ...
                ViewState.Item("SysID") = ht("SysID").ToString()
                subGetData(ht("SysID").ToString(), ht("SelectedFunID").ToString())
    ...
    Private Sub subGetData(ByVal SysID As String, ByVal FunID As String)
        Dim objSC As New SC
        Dim bsFun As New beSC_Fun.Service()
        Dim beFun As New beSC_Fun.Row()

        beFun.SysID.Value = SysID
        ...
        Try
            Using dt As DataTable = bsFun.QueryByKey(beFun).Tables(0)
                ...
                lblSysName.Text = beFun.SysID.Value
                ...
                Dim CompName As String = objSC.GetSC_CompName(beFun.LastChgComp.Value)
                lblLastChgComp.Text = beFun.LastChgComp.Value + IIf(CompName <> "", "-" + CompName, "")
                Dim UserName As String = objSC.GetSC_UserName(beFun.LastChgComp.Value, beFun.LastChgID.Value)
                lblLastChgID.Text = beFun.LastChgID.Value + IIf(UserName <> "", "-" + UserName, "")
    ...
    Private Function SaveData() As Boolean
        ...
        'beFun.SysID.Value = lblSysName.Text
        ...
        If txtFunRight.Text <> "" Then
            ...
            For intLoop As Integer = 0 To aryRights.GetUpperBound(0)
                ...
                'beChildFunRight.SysID.Value = lblSysName.Text
                beChildFunRight.SysID.Value = arySysID(0)
