<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SC0442.aspx.vb" Inherits="SC_SC0442" %>
                    ...
                    <table width="80%" class="tbl_Edit" cellpadding="1" cellspacing="1">
                        <tr style="height:20px">
                            ...
                            <td class="td_detail" style="width:70%" align="left">
                                ...
                                <asp:TextBox ID="tbxYear" runat="server" MaxLength="4" Enabled="false" CssClass="InputTextStyle_Thin number"></asp:TextBox>
                            </td>
                        </tr>
                        <tr style="height:20px">
                            <th class="td_header" width="30%">*類別</th>
                            <td class="td_detail" style="width:70%" align="left">
                                <asp:DropDownList runat="server" ID="ddlType" Enabled="false" CssClass="DropDownListStyle" />
                            </td>
                        </tr>
                        <tr style="height:20px">
                            <th class="td_header" width="30%">*評等</th>
                            <td class="td_detail" style="width:70%" align="left">
                                <asp:DropDownList runat="server" ID="ddlRank" Enabled="false" CssClass="DropDownListStyle">
