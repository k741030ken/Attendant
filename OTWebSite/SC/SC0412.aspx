<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SC0412.aspx.vb" Inherits="SC_SC0412" %>
                ...
                <td align="center">
                    <table width="95%" class="tbl_Edit" cellpadding="1" cellspacing="1">
                        <tr style="height:20px">
                            <td class="td_EditHeader" width="15%" align="center"><asp:Label ID="lblFlowIDH" CssClass="MustInputCaption" runat="server" Text="*流程名稱"></asp:Label>
                            </td>
                            <td class="td_Edit" style="width:85%" align="left"><asp:Label ID="lblFlowIDNm" runat="server" ForeColor="Blue" CssClass="InputTextStyle_Thin" Width="100px"></asp:Label>
                                <asp:Label ID="lblFlowID" runat="server" style="display:none" ></asp:Label>
                            </td>
                        </tr>
                        <tr style="height:20px">
                            <td class="td_EditHeader" width="15%" align="center"><asp:Label ID="lblFlowVerH" CssClass="MustInputCaption" runat="server" Text="*流程版本"></asp:Label>
                            </td>
                            <td class="td_Edit" style="width:85%" align="left"><asp:Label ID="lblFlowVer" runat="server" ForeColor="Blue" CssClass="InputTextStyle_Thin" Width="100px"></asp:Label>
                            </td>
                        </tr>
                        <tr style="height:20px">
                            <td class="td_EditHeader" width="15%" align="center"><asp:Label ID="lblFlowStepIDH" CssClass="MustInputCaption" runat="server" Text="*關卡編號"></asp:Label>
                            </td>
                            <td class="td_Edit" style="width:85%" align="left"><asp:Label ID="lblFlowStepID" runat="server" ForeColor="Blue" CssClass="InputTextStyle_Thin" Width="100px"></asp:Label>
                            </td>
                        </tr>
                        <tr style="height:20px">
                            <td class="td_EditHeader" width="15%" align="center"><asp:Label ID="lblDescription" runat="server" Text="關卡名稱"></asp:Label>
                            </td>
                            <td class="td_Edit" style="width:85%" align="left"><asp:TextBox ID="txtDescription" Width="300px" CssClass="InputTextStyle_Thin" runat="server" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr style="height:20px">
                            <td class="td_EditHeader" width="15%" align="center"><asp:Label ID="lblMenuTitle" runat="server" Text="選單名稱"></asp:Label>
                            </td>
                            <td class="td_Edit" style="width:85%" align="left"><asp:TextBox ID="txtMenuTitle" Width="300px" CssClass="InputTextStyle_Thin" runat="server" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr style="height:20px">
                            ...
                            <td class="td_Edit" style="width:85%" align="left">
                                ...
                                <asp:GridView ID="gvMain" CssClass="GridViewStyle" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="After SQL">
                                            <ItemStyle CssClass="td_detail" Height="15px" HorizontalAlign="center"  />
                                            <HeaderStyle CssClass="td_header" Width="6%" />
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEditAfterSQL" runat="server" Text="View" CommandName="ViewSQL" ToolTip="Show After-SQL"></asp:LinkButton>
                                                <asp:Label ID="lblAfterSQL" runat="server" Visible="false"></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:LinkButton ID="btnEditAfterSQL" runat="server" Text="Edit" CommandName="EditSQL" ToolTip="Edit After-SQL"></asp:LinkButton>
                                                <asp:Label ID="lblAfterSQL" runat="server" Visible="false"></asp:Label>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="">
                        ...
                        <tr style="height:20px">
                            <td class="td_EditHeader" width="20%" align="center">
                                <asp:Label ID="lblLastChgID_H" runat="server" Text="最後異動人員"></asp:Label></td>
                            <td class="td_Edit" style="width: 80%;" align="left">
