...
Partial Class OV_OV6000
    ...
    Private Sub DoAdd()
        ...
        Me.TransferFramePage("~/OV/OV6001.aspx", New ButtonState() {btnA, btnX, btnC}, _
    ...
    Private Sub DoUpdate()
        ...
        Me.TransferFramePage("~/OV/OV6002.aspx", New ButtonState() {btnU, btnX, btnC}, _
    ...
    Protected Sub gvMain_RowDataBound(ByVal sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvMain.RowCommand
        ...
        If e.CommandName = "Detail" Then
            ...
            Me.TransferFramePage("~/OV/OV6002.aspx", New ButtonState() {btnX}, _
                ddlCompID.ID & "=" & strCompID, _
                txtEmpID.ID & "=" & txtEmpID.Text, _
                txtEmpName.ID & "=" & txtEmpName.Text, _
                "PageNo=" & pcMain.PageNo.ToString(), _
