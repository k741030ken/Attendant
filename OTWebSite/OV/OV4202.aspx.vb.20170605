...
#Region "畫面邏輯"
    ...
    Protected Sub LoadData()
        ...
        If _OTStartDate = _OTEndDate Then
            ...
            If Integer.TryParse(sOTTimeStart, iOTTimeStart) AndAlso Integer.TryParse(sOTTimeEnd, iOTTimeEnd) Then
                ...
                Dim bPeriodCount As Boolean = objOV42.PeriodCount("OverTimeDeclaration", _EmpID, cntTotal, 0, StartDateArr, EndDateArr, _
        ...
        Else    '跨日
            ...
            If Integer.TryParse(sOTTimeStart, iOTTimeStart) AndAlso Integer.TryParse(sOTTimeEnd, iOTTimeEnd) Then
                ...
                Dim bPeriodCount As Boolean = objOV42.PeriodCount("OverTimeDeclaration", _EmpID, cntStart, cntEnd, StartDateArr, EndDateArr, iMealTime, mealFlag, _OTTxnID, returnPeriodCount)
    ...
    Protected Sub subGetData()
        ...
        _dtPara = objOV42.Json2DataTable(objOV42.QueryColumn("Para", "OverTimePara", " AND CompID = '" + dt.Rows(0)("OTCompID").ToString().Trim + "'"))
...
#Region "功能鍵邏輯處理"
    ...
    Public Sub SaveData(flag As String)
        ...
        Dim mealOver As String = objOV42.MealJudge(cntStart, Convert.ToDouble(txtMealTime.Text))

        Dim attach As String = objOV42.QueryAttach(_AttachID, lblCompID.Text.Trim, _EmpID)
        ...
        If _OTStartDate = _OTEndDate Then     '原本不跨日
            If ucOTStartDate.DateText = ucOTEndDate.DateText Then    '不跨日
                Dim strHo As String = objOV42.QueryColumn("HolidayOrNot", _eHRMSDB_ITRD + ".[dbo].[Calendar] ", " AND CompID = '" + lblCompID.Text.Trim + "' AND CONVERT(CHAR(10),SysDate, 111) ='" + ucOTStartDate.DateText + "'")
                getCntTotal(cntTotal)
                OTSeq = objOV42.QuerySeq("OverTimeDeclaration", lblCompID.Text.Trim, _EmpID, ucOTStartDate.DateText)
            ...
            Else
                Dim strHo1 As String = objOV42.QueryColumn("HolidayOrNot", _eHRMSDB_ITRD + ".[dbo].[Calendar] ", " AND CompID = '" + lblCompID.Text.Trim + "' AND CONVERT(CHAR(10),SysDate, 111) ='" + ucOTStartDate.DateText + "'")
                Dim strHo2 As String = objOV42.QueryColumn("HolidayOrNot", _eHRMSDB_ITRD + ".[dbo].[Calendar] ", " AND CompID = '" + lblCompID.Text.Trim + "' AND CONVERT(CHAR(10),SysDate, 111) ='" + ucOTEndDate.DateText + "'")
                getCntStartAndCntEnd(cntStart, cntEnd)
                OTSeq = objOV42.QuerySeq("OverTimeDeclaration", lblCompID.Text.Trim, _EmpID, ucOTStartDate.DateText)
                ...
                OTSeq_1 = objOV42.QuerySeq("OverTimeDeclaration", lblCompID.Text.Trim, _EmpID, ucOTEndDate.DateText)
    ...
    Private Sub ExecuteSubmit()
        ...
        'sb.Append(" VALUES('AP', 'OT', 'OV4202', '" + UserProfile.ActUserID + "', '" + hidGuidID.Value + "', '" + Newtonsoft.Json.JsonConvert.SerializeObject(DataList) + "', GETDATE(), '30')")
...
#Region "檢查Funct"
    ...
    Public Function checkData(flag As String) As Boolean
            ...
            If ucOTStartDate.DateText <> ucOTEndDate.DateText Then
                ...
                ElseIf (Not OVBusinessCommon.IsNationalHoliday(ucOTStartDate.DateText)) Then    '如果加班起日是非周末之一般假日
                    ...
                    Else
                        ...
                        If Not objOV42.CheckNHolidayOTOrNot(lblCompID.Text.Trim, _EmpID, ucOTStartDate.DateText, ucOTEndDate.DateText, _OTTxnID, "Upd", ChkMsg) Then
                            ErrMsg += ChkMsg
                        End If
                    End If
                    'ElseIf Weekday(Convert.ToDateTime(ucOTStartDate.DateText)) = 0 Then '如果加班起日是周末之一般假日
                    '    If objOV42.CheckHolidayOrNot(ucOTEndDate.DateText) AndAlso Not OVBusinessCommon.IsNationalHoliday(ucOTStartDate.DateText) Then
                    '        ErrMsg += "不能假日連續加班" & vbNewLine    '一般周末假日跨非周末的一般假日為假日連續加班
                    '    End If
                    '    If Not OVBusinessCommon.IsNationalHoliday(ucOTStartDate.DateText) AndAlso objOV42.CheckHolidayOrNot(ucOTEndDate.DateText) Then
        ...
        '        dt = objOV42.QueryData("*", "OverTimeDeclaration", " AND OTStartDate='" + a.ToString("yyyy/MM/dd") + "' AND OTCompID='" + lblCompID.Text.Trim + "' AND OTEmpID='" + _EmpID + "' AND OTStatus in ('1','2','3') AND OTStartDate <> ( SELECT Code FROM AT_CodeMap WHERE Code = OTStartDate AND NotShowFlag = '0' AND TabName = 'NationalHolidayDefine' AND FldName ='HolidayDate')")
        ...
        '        dt = objOV42.QueryData("*", "OverTimeDeclaration", " AND OTStartDate='" + b.ToString("yyyy/MM/dd") + "' AND OTCompID='" + lblCompID.Text.Trim + "' AND OTEmpID='" + _EmpID + "' AND OTStatus in ('1','2','3') AND OTStartDate <> ( SELECT Code FROM AT_CodeMap WHERE Code = OTStartDate AND NotShowFlag = '0' AND TabName = 'NationalHolidayDefine' AND FldName ='HolidayDate')")
        '        If dt.Rows.Count > 0 Then
        '            '20170314-HR不擋僅通知-讓檢核能通過
        '            'Bsp.Utility.ShowMessage(Me, "不能假日連續加班")
        '            'Return False
        ...
        '    '檢查事先申請是否連續加班
        '    If objOV42.CheckHolidayOrNot(a.ToString("yyyy/MM/dd")) Then
        '        dt = objOV42.QueryData("*", "OverTimeAdvance", " AND OTStartDate='" + a.ToString("yyyy/MM/dd") + "' AND OTCompID='" + lblCompID.Text.Trim + "' AND OTEmpID='" + _EmpID + "' AND OTStatus in ('1','2','3') AND OTStartDate <> ( SELECT Code FROM AT_CodeMap WHERE Code = OTStartDate AND NotShowFlag = '0' AND TabName = 'NationalHolidayDefine' AND FldName ='HolidayDate')")
        '        If dt.Rows.Count > 0 Then
        '            '20170314-HR不擋僅通知-讓檢核能通過
        '            'Bsp.Utility.ShowMessage(Me, "不能假日連續加班")
        '            'Return False
        ...
        '        End If
        '    ElseIf objOV42.CheckHolidayOrNot(b.ToString("yyyy/MM/dd")) Then
        '        dt = objOV42.QueryData("*", "OverTimeAdvance", " AND OTStartDate='" + b.ToString("yyyy/MM/dd") + "' AND OTCompID='" + lblCompID.Text.Trim + "' AND OTEmpID='" + _EmpID + "' AND OTStatus in ('1','2','3') AND OTStartDate <> ( SELECT Code FROM AT_CodeMap WHERE Code = OTStartDate AND NotShowFlag = '0' AND TabName = 'NationalHolidayDefine' AND FldName ='HolidayDate')")
        '        If dt.Rows.Count > 0 Then
        '            '20170314-HR不擋僅通知-讓檢核能通過
        '            'Bsp.Utility.ShowMessage(Me, "不能假日連續加班")
        '            'Return False
        ...
        If Month(Convert.ToDateTime(ucOTStartDate.DateText)) = Month(Convert.ToDateTime(ucOTEndDate.DateText)) Then     '無跨月
            If Not objOV42.checkMonthTime("OverTimeDeclaration", lblCompID.Text.Trim, _EmpID, ucOTStartDate.DateText, ucOTEndDate.DateText, Convert.ToDouble(_dtPara.Rows(0)("MonthLimitHour").ToString()), cntTotal, Convert.ToDouble(txtMealTime.Text.Trim), _
        ...
        Else    '有跨月
            ...
            '先算加班開始日期部分
            If Not objOV42.checkMonthTime("OverTimeDeclaration", lblCompID.Text.Trim, _EmpID, ucOTStartDate.DateText, ucOTStartDate.DateText, Convert.ToDouble(_dtPara.Rows(0)("MonthLimitHour").ToString()), cntStart, mealOver.Split(","c)(1), _
            ...
            '再算加班結束日期部分
            If Not objOV42.checkMonthTime("OverTimeDeclaration", lblCompID.Text.Trim, _EmpID, ucOTEndDate.DateText, ucOTEndDate.DateText, Convert.ToDouble(_dtPara.Rows(0)("MonthLimitHour").ToString()), cntEnd, mealOver.Split(","c)(3), _
...
#Region "日期與時間連動"
    ...
    Protected Sub ValidStartTime_Click(sender As Object, e As System.EventArgs) Handles ValidStartTime.Click
        Dim objOV42 As New OV4_2
        If ViewState.Item("DoUpdate") = "Y" Then
            Dim Sex As String = objOV42.QueryColumn("Sex", _eHRMSDB_ITRD + ".[dbo].[Personal] ", " AND EmpID='" + _EmpID + "'")
    ...
    Protected Sub ValidEndTime_Click(sender As Object, e As System.EventArgs) Handles ValidEndTime.Click
        ...
        If ViewState.Item("DoUpdate") = "Y" Then
            ...
            If ucOTStartTime.ucDefaultSelectedHH <> "請選擇" And ucOTStartTime.ucDefaultSelectedMM <> "請選擇" And ucOTStartTime.ucDefaultSelectedHH <> "" And ucOTStartTime.ucDefaultSelectedMM <> "" And ucOTEndTime.ucDefaultSelectedHH <> "" And ucOTEndTime.ucDefaultSelectedMM <> "" And ucOTEndTime.ucDefaultSelectedHH <> "請選擇" And ucOTEndTime.ucDefaultSelectedMM <> "請選擇" Then
                Dim Sex As String = objOV42.QueryColumn("Sex", _eHRMSDB_ITRD + ".[dbo].[Personal] ", " AND EmpID =" + Bsp.Utility.Quote(_EmpID))
                    ...
                    If (_EmpID <> "") Then
                        ...
                        If bOTTimeStart And bOTTimeEnd Then
                            ...
                            If (Integer.TryParse(sOTTimeStart.Replace(":", ""), iOTTimeStart) And (Integer.TryParse(sOTTimeEnd.Replace(":", ""), iOTTimeEnd))) Then
                                ...
                                Dim bPeriodCount As Boolean = objOV42.PeriodCount("OverTimeDeclaration", lblOTEmpID.Text.Trim, cntTotal, 0, StartDateArr, EndDateArr, iMealTime, smealFlag, "", returnPeriodCount)
                    ...
                    If _EmpID <> "" Then
                        ...
                        If bOTTimeStart And bOTTimeEnd Then
                            ...
                            If (Integer.TryParse(sOTTimeStart, iOTTimeStart) And (Integer.TryParse(sOTTimeEnd, iOTTimeEnd))) Then
                                ...
                                Dim bPeriodCount As Boolean = objOV42.PeriodCount("OverTimeDeclaration", lblOTEmpID.Text.Trim, cntStart, cntEnd, StartDateArr, EndDateArr, iMealTime, smealFlag, "", returnPeriodCount)
                                If bPeriodCount And String.IsNullOrEmpty(returnPeriodCount) <> True And returnPeriodCount.Split(";").Length > 0 Then
                                    Dim sReturnPeriodList = returnPeriodCount.Split(";")
        ...
        If ViewState.Item("DoUpdate") = "Y" Then
            ...
            Else
                ...
                If cntTotal > 120 Then
                    '加班超過兩小時需扣用餐時間60分鐘
                    txtMealTime.Enabled = True
                    Dim strHo As String = objOV42.QueryColumn("HolidayOrNot", _eHRMSDB_ITRD + ".[dbo].[Calendar] ", " AND CompID = '" + UserProfile.SelectCompRoleID.Trim + "' AND CONVERT(CHAR(10),SysDate, 111) ='" + ucOTStartDate.DateText + "'")
                    If Not String.IsNullOrEmpty(strHo) Then
                        If strHo = "0" Then
                ...
                Else
                    ...
                    If bOTTimeStart AndAlso bOTTimeEnd Then
                        ...
                        If Integer.TryParse(sOTTimeStart, iOTTimeStart) AndAlso Integer.TryParse(sOTTimeEnd, iOTTimeEnd) Then
                            ...
                            Dim bPeriodCount As Boolean = objOV42.PeriodCount("OverTimeDeclaration", _EmpID, cntTotal, 0, StartDateArr, EndDateArr, iMealTime, mealFlag, _
                ...
                Else
                    ...
                    If bOTTimeStart AndAlso bOTTimeEnd Then
                        ...
                        If Integer.TryParse(sOTTimeStart, iOTTimeStart) AndAlso Integer.TryParse(sOTTimeEnd, iOTTimeEnd) Then
                            ...
                            Dim bPeriodCount As Boolean = objOV42.PeriodCount("OverTimeDeclaration", _EmpID, cntStart, cntEnd, StartDateArr, EndDateArr, iMealTime, mealFlag, _
                             _OTTxnID, returnPeriodCount)
...
#Region "清除送簽快取"
    ...
    Private Function ClearCacheData() As Boolean
        Dim sb As New StringBuilder
        sb.Append("DELETE * FROM CacheData WHERE 1=1 AND UserID = " + Bsp.Utility.Quote(UserProfile.ActUserID) + " AND Platform = 'AP' AND SystemID = 'OT' AND TxnName = 'OV4202'")
        Try
