                ...
                <table width="98%" class="tbl_Edit" cellpadding="1" cellspacing="1">
                    ...
                    <tr style="height: 20px">
                        ...
                        <td class="td_Edit" width="75%">
                            ...
                            <asp:FilteredTextBoxExtender ID="fttxtAdvaceBegin" runat="server" TargetControlID="txtAdvaceBegin"
                                FilterType="Numbers">
                            </asp:FilteredTextBoxExtender>
                            <asp:TextBox ID="txtAdvaceBegin" runat="server" Width="30px" AutoComplete="off" Font-Names="微軟正黑體"
                                MaxLength="3"></asp:TextBox>
                            <asp:Label ID="Label4" runat="server" Text="日前、" Font-Names="微軟正黑體"></asp:Label>
                            <asp:FilteredTextBoxExtender ID="fttxtAdvanceEnd" runat="server" TargetControlID="txtAdvanceEnd"
                                FilterType="Numbers">
                            </asp:FilteredTextBoxExtender>
                            <asp:TextBox ID="txtAdvanceEnd" runat="server" Width="30px" AutoComplete="off" Font-Names="微軟正黑體"
                                MaxLength="3"></asp:TextBox>
                            ...
                            <asp:FilteredTextBoxExtender ID="fttxtDeclarationBegin" runat="server" TargetControlID="txtDeclarationBegin"
                                FilterType="Numbers">
                            </asp:FilteredTextBoxExtender>
                            <asp:TextBox ID="txtDeclarationBegin" runat="server" Width="30px" AutoComplete="off"
                                Font-Names="微軟正黑體" MaxLength="3"></asp:TextBox>
                    ...
                    <tr style="height: 20px">
                        ...
                        <td class="td_Edit" width="75%">
                            ...
                            <asp:RadioButton ID="rbtnOTMustCheckYes" GroupName="OTMustCheck" runat="server" Text="需檢核"
                                Font-Names="微軟正黑體" />
                            <asp:RadioButton ID="rbtnOTMustCheckNo" GroupName="OTMustCheck" runat="server" Text="不需檢核"
                                Font-Names="微軟正黑體" /><br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="Label16" runat="server" Text="日數限制" Font-Names="微軟正黑體"></asp:Label>
                            <asp:FilteredTextBoxExtender ID="fttxtOTLimitDay" runat="server" TargetControlID="txtOTLimitDay"
                                FilterType="Numbers">
                            </asp:FilteredTextBoxExtender>
                            <asp:TextBox ID="txtOTLimitDay" runat="server" Width="20px" AutoComplete="off" Font-Names="微軟正黑體"
                            ...
                            <asp:RadioButton ID="rbtnOTLimitFlagPrompt" GroupName="OTLimitFlag" runat="server"
                                Text="提示" Font-Names="微軟正黑體" />
                            <asp:RadioButton ID="rbtnOTLimitFlagApply" GroupName="OTLimitFlag" runat="server"
                                Text="限制" Font-Names="微軟正黑體" />
                        </td>
                    </tr>
                    <tr style="height: 20px">
                        <td class="td_Edit" width="25%">
                        ...
                        <td class="td_Edit" width="75%">
                            ...
                            <asp:FilteredTextBoxExtender ID="fttxtDayLimitHourN" runat="server" TargetControlID="txtDayLimitHourN"
                                FilterType="Numbers">
                            </asp:FilteredTextBoxExtender>
                            <asp:TextBox ID="txtDayLimitHourN" runat="server" Width="20px" AutoComplete="off"
                                Font-Names="微軟正黑體" MaxLength="2"></asp:TextBox>
                            ...
                            <asp:FilteredTextBoxExtender ID="fttxtDayLimitHourH" runat="server" TargetControlID="txtDayLimitHourH"
                                FilterType="Numbers">
                            </asp:FilteredTextBoxExtender>
                            <asp:TextBox ID="txtDayLimitHourH" runat="server" Width="20px" AutoComplete="off"
                                Font-Names="微軟正黑體" MaxLength="2"></asp:TextBox>
                            ...
                            <asp:RadioButton ID="rbtnDayLimitFlagPrompt" GroupName="DayLimitFlag" runat="server"
                                Text="提示" Font-Names="微軟正黑體" />
                            <asp:RadioButton ID="rbtnDayLimitFlagApply" GroupName="DayLimitFlag" runat="server"
                                Text="限制申請" Font-Names="微軟正黑體" />
                        </td>
                    </tr>
                    <tr style="height: 20px">
                        <td class="td_Edit" width="25%">
                        ...
                        <td class="td_Edit" width="75%">
                            ...
                            <asp:FilteredTextBoxExtender ID="fttxtMonthLimitHour" runat="server" TargetControlID="txtMonthLimitHour"
                                FilterType="Numbers">
                            </asp:FilteredTextBoxExtender>
                            <asp:TextBox ID="txtMonthLimitHour" runat="server" Width="20px" AutoComplete="off"
                                Font-Names="微軟正黑體" MaxLength="2"></asp:TextBox>
                            ...
                            <asp:RadioButton ID="rbtnMonthLimitFlagPrompt" GroupName="MonthLimitFlag" runat="server"
                                Text="提示" />
                            <asp:RadioButton ID="rbtnMonthLimitFlagApply" GroupName="MonthLimitFlag" runat="server"
                                Text="限制申請" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="td_Edit" width="75%">
                            ...
                            <asp:DropDownList ID="ddlEmpRankID" runat="server">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td class="td_Edit" width="75%">
                            ...
                            <asp:DropDownList ID="ddlValidRankID" runat="server">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td class="td_Edit" width="75%">
                            ...
                            <asp:DropDownList ID="ddlAdjustRankID" runat="server">
                            </asp:DropDownList>
                    ...
                    <tr style="height: 20px">
                        ...
                        <td class="td_Edit" width="75%">
                            <asp:RadioButton ID="rbtnTurnAdjust" GroupName="SalaryOrAdjust" runat="server" Text="轉補休"
                                Font-Names="微軟正黑體" />
                            <asp:RadioButton ID="rbtnTurnSalary" GroupName="SalaryOrAdjust" runat="server" Text="轉薪資"
                                Font-Names="微軟正黑體" />
                        </td>
                    </tr>
                    <tr style="height: 20px">
                        ...
                        <td class="td_Edit" width="75%">
                            <uc:ucCalender ID="txtAdjustInvalidDate" runat="server" CssClass="InputTextStyle_Thin"
                    ...
                    <tr style="height: 20px">
                        <td class="td_Edit" width="25%">
                            <asp:Label ID="lblStayBehind" runat="server" Text="留守時數上限" Font-Names="微軟正黑體"></asp:Label>
                        </td>
                        <td class="td_Edit" width="75%">
                            每日可留守時數上限&nbsp;&nbsp;
                            <asp:TextBox ID="txtStayBehind" Width="30px" runat="server" MaxLength="2" OnKeyPress="if(((event.keyCode >= 48) && (event.keyCode <= 57)) || (event.keyCode == 46)) {event.returnValue = true;} else{event.returnValue = false;}"></asp:TextBox>
                            小時
                        </td>
                    </tr>
                    <tr style="height: 20px">
