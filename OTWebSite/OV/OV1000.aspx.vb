...
Partial Class OV_OV1000
    ...
    Protected Sub DoAdd()
        ...
        Me.TransferFramePage("~/OV/OV1001.aspx", New ButtonState() {btnA, btnX, btnC}, _
        ...
        Else
            Try
                ...
                If CityVEmp = "CityTable" Then
                    ...
                    'Me.TransferFramePage("~/OV/OV1002.aspx", New ButtonState() {btnA, btnX, btnC}, _
