...
Partial Class OV_OV8000
    ...
    Protected Sub DoUpdate()
        ...
        If selectedRows(gvMain) <> "" Then
            ...
            If intSelectCount = 1 Then
                ...
                Me.TransferFramePage("~/OV/OV8002.aspx", New ButtonState() {btnU, btnE, btnX, btnC}, _
    ...
    Protected Sub DoAdd()
        ...
        Me.TransferFramePage("~/OV/OV8001.aspx", New ButtonState() {btnA, btnE, btnX, btnC}, _
            txtFlowCode.ID & "=" & txtFlowCode.Text, _
            txtFlowName.ID & "=" & txtFlowName.Text, _
            txtFlowSN.ID & "=" & txtFlowSN.Text, _
            txtFlowSeq.ID & "=" & txtFlowSeq.Text, _
    ...
    Protected Sub gvMain_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvMain.RowCommand
        ...
        If e.CommandName = "Detail" Then
            ...
            If selectedRows(gvMain) <> "" Then
                ...
                Next
                If intSelectCount = 1 Then
                    TransferFramePage("~/OV/OV8003.aspx", New ButtonState() {btnC}, a, _
                        txtFlowCode.ID & "=" & txtFlowCode.Text, _
                        txtFlowName.ID & "=" & txtFlowName.Text, _
                        txtFlowSN.ID & "=" & txtFlowSN.Text, _
                        txtFlowSeq.ID & "=" & txtFlowSeq.Text, _
