...
#Region "畫面與功能鍵"
    ...
    Protected Sub txtEmpID_TextChanged(sender As Object, e As System.EventArgs) Handles txtEmpID.TextChanged
        If txtEmpID.Text.Trim <> "" Then
            ...
            Dim rtnTable As DataTable = objOV11.GetEmpName(hidCompID.Value, txtEmpID.Text.Trim)
...
#Region "功能鍵執行動作"
    ...
    Private Sub DoAdd()
        ...
        Try
            Me.TransferFramePage("~/OV/OV1101.aspx", New ButtonState() {btnA, btnE, btnD, btnX, btnC}, _
        ...
        Try
            ...
            Else
                ...
                If intSelectCount = 1 Then
                    ...
                    Me.TransferFramePage("~/OV/OV1102.aspx", New ButtonState() {btnU, btnE, btnX, btnC}, _
                           lblCompID.ID & "=" & lblCompID.Text, _
                           hidCompID.ID & "=" & hidCompID.Value.ToString, _
                           lblDeptID.ID & "=" & lblDeptID.Text, _
                           hidDeptID.ID & "=" & hidDeptID.Value.ToString, _
    ...
    Protected Sub gvMain_RowDataBound(ByVal sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvMain.RowCommand
        If e.CommandName = "Detail" Then
            ...
            Try
                ...
                Me.TransferFramePage("~/OV/OV1102.aspx", New ButtonState() {btnX}, _
                       lblCompID.ID & "=" & lblCompID.Text, _
                       hidCompID.ID & "=" & hidCompID.Value.ToString, _
                       lblDeptID.ID & "=" & lblDeptID.Text, _
                       hidDeptID.ID & "=" & hidDeptID.Value.ToString, _
        ...
        Try
            ...
            Else
                ...
                If jsonlist.Count > 0 Then
                    ...
                    sb.Append(" VALUES('AP', 'OT', 'OV1100', '" + UserProfile.ActUserID + "', '" + hidGuidID.Value + "', '" + Newtonsoft.Json.JsonConvert.SerializeObject(DataList) + "', GETDATE(), '30')")
...
#Region "清除送簽快取"
    ...
    Private Function ClearCacheData() As Boolean
        Dim sb As New StringBuilder
        sb.Append("DELETE * FROM CacheData WHERE 1=1 AND UserID = " + Bsp.Utility.Quote(UserProfile.ActUserID) + " AND Platform = 'AP' AND SystemID = 'OT' AND TxnName = 'OV1100'")
        Try
