var famdata = {
    ...
    items: [
        { id: 3, title: "James Holt 2", label: "James Holt", description: "3, Sr. VP, Server & Tools Division", phone: "262-215-7998", email: "jameholt@name.com", image: "demo/images/photos/e.png", itemTitleColor: "#4b0082" },
        { id: 4, title: "Thomas Williams 2", label: "Thomas Williams", description: "4, VP, Server & Tools Marketing and Solutions", phone: "904-547-5342", email: "thomwill@name.com", image: "demo/images/photos/r.png", itemTitleColor: "#4b0082" },
        { id: 5, title: "David Kirby 2", label: "David Kirby", description: "5, AGM, Infrastructure Server and IT Pro Audience Marketing", phone: "614-395-7238", email: "davikirb@name.com", image: "demo/images/photos/t.png", itemTitleColor: "#4b0082" },
        { id: 6, title: "Lynette Maloney 2", label: "Lynette Maloney", description: "6, GM, Name.com Experience Platforms and Solutions", phone: "540-822-3862", email: "lynemalo@name.com", image: "demo/images/photos/y.png", itemTitleColor: "#4b0082" },
...
var sideBySide = {
    ...
    items: [
        { id: 1, title: "David Dalton", label: "David Dalton", description: "1, Chief Executive Officer (CEO)", phone: "352-206-7599", email: "davidalt@name.com", image: "demo/images/photos/q.png", itemTitleColor: "#ff0000" },
        { id: 2, title: "Jeanna White", label: "Jeanna White", description: "2, Co-Presidents, Platform Products & Services Division", phone: "505-791-1689", email: "jeanwhit@name.com", image: "demo/images/photos/w.png", itemTitleColor: "#ff0000" },
        { id: 3, title: "James Holt", label: "James Holt", description: "3, Sr. VP, Server & Tools Division", phone: "262-215-7998", email: "jameholt@name.com", image: "demo/images/photos/e.png", itemTitleColor: "#ff0000" },
        { id: 4, title: "Thomas Williams", label: "Thomas Williams", description: "4, VP, Server & Tools Marketing and Solutions", phone: "904-547-5342", email: "thomwill@name.com", image: "demo/images/photos/r.png", itemTitleColor: "#ff0000" },
        { id: 5, title: "David Kirby", label: "David Kirby", description: "5, GM, Infrastructure Server and IT Pro Audience Marketing", phone: "614-395-7238", email: "davikirb@name.com", image: "demo/images/photos/t.png", itemTitleColor: "#ff0000" },
        { id: 6, title: "Lynette Maloney", label: "Lynette Maloney", description: "6, GM, Name.com Experience Platforms and Solutions", phone: "540-822-3862", email: "lynemalo@name.com", image: "demo/images/photos/y.png", itemTitleColor: "#ff0000" },
        { id: 7, title: "Glen Zeigler", label: "Glen Zeigler", description: "7, GM, Core Infrastructure Solutions", phone: "920-665-7222", email: "glenzeig@name.com", image: "demo/images/photos/u.png", itemTitleColor: "#ff0000" },
        { id: 8, title: "Ione Gallegos", label: "Ione Gallegos", description: "8, GM, Patterns & Practices", phone: "478-322-5539", email: "ionegall@name.com", image: "demo/images/photos/i.png", itemTitleColor: "#ff0000" },
        ...
        { id: 25, title: "Ashley Rue", label: "Ashley Rue", description: "25, Root item, it is placed close to its children.", phone: "515-324-4969", email: "ashlrue@name.com", image: "demo/images/photos/n.png", itemTitleColor: "#ff0000" },
        { id: 26, title: "Joan Whitham", label: "Joan Whitham", description: "26, Root item, it is placed close to its children.", phone: "914-614-5020", email: "joanwhit@name.com", image: "demo/images/photos/m.png", itemTitleColor: "#ff0000" },
        ...
        { id: 28, title: "Roger Greenlee", label: "Roger Greenlee", description: "28, Root item, it is placed close to its children.", phone: "847-510-2148", email: "rogegree@name.com", image: "demo/images/photos/w.png", itemTitleColor: "#ff0000" },
        { id: 29, title: "Janella Cannon", label: "Janella Cannon", description: "29, Root item, it is placed close to its children.", phone: "484-870-9064", email: "janecann@name.com", image: "demo/images/photos/q.png", itemTitleColor: "#ff0000" },
        ...
        { id: 37, title: "Abbie Lawson", label: "Abbie Lawson", description: "37, Root item, it is placed close to its children.", phone: "530-322-6413", email: "abbilaws@name.com", image: "demo/images/photos/a.png", itemTitleColor: "#ff0000" },
...
var alignmentData = {
    ...
    items: [
        ...
        { id: 6, parents: [1], title: "Aligned Item", label: "Aligned Item", description: "Use GroupBy Parents/Children option to align this item", phone: "620-368-3620", email: "heatsimm@name.com", image: "demo/images/photos/p.png", itemTitleColor: "#ff0000" },
...
var famdataCascade = {
    ...
    items: [
        { id: 10, title: "James", label: "James", description: "Parent of: Steven, Heather, Ione, Glen & Sara", phone: "262-215-7998", email: "jameholt@name.com", image: "demo/images/photos/e.png", itemTitleColor: "#4b0082" },
        { id: 11, title: "Brad", label: "Brad", description: "Parent of: Heather, Ione, Glen & Sara", phone: "502-528-6379", email: "bradwhit@name.com", image: "demo/images/photos/f.png", itemTitleColor: "#4b0082" },
        { id: 12, title: "Thomas", label: "Thomas", description: "Parent of: Ione, Glen & Sara", phone: "904-547-5342", email: "thomwill@name.com", image: "demo/images/photos/r.png", itemTitleColor: "#4b0082" },
        { id: 13, title: "David", label: "David", description: "Parent of: Glen & Sara", phone: "614-395-7238", email: "davikirb@name.com", image: "demo/images/photos/t.png", itemTitleColor: "#4b0082" },
        { id: 14, title: "Lynette", label: "Lynette", description: "Parent of Sara", phone: "540-822-3862", email: "lynemalo@name.com", image: "demo/images/photos/y.png", itemTitleColor: "#4b0082" },
        { id: 1, parents: [10, 11, 12, 13, 14], title: "Sara", label: "Sara", description: "Child of James, Brad, Thomas, David & Lynette", phone: "918-257-4218", email: "sarakemp@name.com", image: "demo/images/photos/g.png", itemTitleColor: "#4b0082" },
        { id: 2, parents: [10, 11, 12, 13], title: "Glen", label: "Glen", description: "Child of James, Brad, Thomas & David", phone: "920-665-7222", email: "glenzeig@name.com", image: "demo/images/photos/u.png", itemTitleColor: "#4b0082" },
        { id: 3, parents: [10, 11, 12], title: "Ione", label: "Ione", description: "Child of James, Brad & Thomas", phone: "478-322-5539", email: "ionegall@name.com", image: "demo/images/photos/i.png", itemTitleColor: "#4b0082" },
        { id: 4, parents: [10, 11], title: "Heather", label: "Heather", description: "Child of James & Brad", phone: "620-368-3620", email: "heatsimm@name.com", image: "demo/images/photos/p.png", itemTitleColor: "#4b0082" },
        { id: 5, parents: [10], title: "Steven", label: "Steven", description: "Child of James", phone: "805-800-7397", email: "stevlaco@name.com", image: "demo/images/photos/a.png", itemTitleColor: "#4b0082" }
    ]
};
...
var famdataLoops = {
    ...
    items: [
        { id: 1, parents: [3, 5, 6, 7], title: "James", label: "James", description: "James is First and he is child of Brad, Sara & Lynette", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 2, parents: [1], title: "Brad", label: "Brad", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 3, parents: [2], title: "Thomas", label: "Thomas", description: "", image: "demo/images/photos/t.png", itemTitleColor: "#4b0082" },
        { id: 4, parents: [3], title: "David", label: "David", description: "", image: "demo/images/photos/d.png", itemTitleColor: "#4b0082" },
        { id: 5, parents: [4], title: "Lynette", label: "Lynette", description: "", image: "demo/images/photos/l.png", itemTitleColor: "#4b0082" },
        { id: 6, parents: [4], title: "Sara", label: "Sara", description: "", image: "demo/images/photos/s.png", itemTitleColor: "#4b0082" },
        { id: 7, title: "Parent", label: "Parent", description: "Parent node of James", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" }
    ]
};
...
var famdataWorld = {
    ...
    items: [
        { id: 1, parents: [], title: "S1", label: "S1", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 2, parents: [1], title: "2", label: "2", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 3, parents: [2], title: "3", label: "3", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 4, parents: [3, 11, 26, 38, 42], title: "4", label: "4", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 5, parents: [4], title: "5", label: "5", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 6, parents: [5], title: "6", label: "6", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 7, parents: [6], title: "7", label: "7", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 8, parents: [], title: "S8", label: "S8", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 9, parents: [8], title: "9", label: "9", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 10, parents: [1], title: "10", label: "10", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 11, parents: [10], title: "11", label: "11", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 12, parents: [10], title: "12", label: "12", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 13, parents: [10], title: "13", label: "13", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 14, parents: [10], title: "14", label: "14", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 15, parents: [14, 16, 20, 39], title: "15", label: "15", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 16, parents: [2], title: "16", label: "16", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 17, parents: [2], title: "17", label: "17", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 18, parents: [2], title: "18", label: "18", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 19, parents: [13, 17, 36, 40], title: "19", label: "19", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 20, parents: [19], title: "20", label: "20", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 21, parents: [19], title: "21", label: "21", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 22, parents: [21], title: "22", label: "22", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 23, parents: [5, 22, 32], title: "23", label: "23", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 24, parents: [], title: "S24", label: "S24", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 25, parents: [24], title: "25", label: "25", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 26, parents: [25], title: "26", label: "26", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 27, parents: [24], title: "27", label: "27", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 28, parents: [19], title: "28", label: "28", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 29, parents: [12, 18, 28, 34, 41], title: "29", label: "29", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 30, parents: [], title: "S30", label: "S30", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 31, parents: [30], title: "31", label: "31", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 32, parents: [31], title: "32", label: "32", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 33, parents: [30], title: "33", label: "33", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 34, parents: [33], title: "34", label: "34", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 35, parents: [], title: "35", label: "35", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 36, parents: [35], title: "36", label: "36", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 37, parents: [], title: "37", label: "37", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 38, parents: [37, 43], title: "38", label: "38", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 39, parents: [37], title: "39", label: "39", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 40, parents: [37, 43], title: "40", label: "40", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 41, parents: [37], title: "41", label: "41", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 42, parents: [9], title: "42", label: "42", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 43, parents: [35], title: "43", label: "43", description: "", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 1001, parents: [2, 9, 10, 15, 23, 25, 31], title: "T1", label: "T1", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 1008, parents: [7], title: "T8", label: "T8", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 1024, parents: [23, 27], title: "T24", label: "T24", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 1030, parents: [29, 33], title: "T30", label: "T30", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 1035, parents: [5, 22], title: "T35", label: "T35", description: "", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" }
    ]
};
...
var famSpouses = {
    ...
    items: [
       { id: "1", parents: ["4", "5"], spouses: ["2", "3"], title: "Victoria Sequeira", label: "Victoria Sequeira", description: "1, GM, Worldwide Licensing", phone: "973-883-9137", email: "victsequ@name.com", image: "demo/images/photos/k.png", itemTitleColor: "#4b0082" },
       { id: "2", title: "Norma Moore", label: "Norma Moore", description: "2, GM, WW Licensing Solutions", phone: "334-496-5203", email: "normmoor@name.com", image: "demo/images/photos/x.png", itemTitleColor: "#4b0082" },
       { id: "3", title: "Carlos Cardenas", label: "Carlos Cardenas", description: "3, GM, Marketing and Readiness", phone: "775-999-3630", email: "carlcard@name.com", image: "demo/images/photos/c.png", itemTitleColor: "#4b0082" },
       { id: "4", spouses: ["5", "22"], title: "Brian Cruz", label: "Brian Cruz", description: "4, GM, Systems Management Server", phone: "320-833-9024", email: "briacruz@name.com", image: "demo/images/photos/h.png", itemTitleColor: "#4b0082" },
       { id: "5", title: "Arthur Wood", label: "Arthur Wood", description: "5, GM, XML Enterprise Services", phone: "630-677-5265", email: "arthwood@name.com", image: "demo/images/photos/f.png", itemTitleColor: "#4b0082" },
       { id: "6", parents: ["4", "5"], title: "Brad Whitt", label: "Brad Whitt", description: "6, GM, Application Platform and Development Marketing", phone: "502-528-6379", email: "bradwhit@name.com", image: "demo/images/photos/f.png", itemTitleColor: "#4b0082" },
       { id: "7", parents: ["5", "4"], title: "George Duong", label: "George Duong", description: "7, Sr. VP, Software Server System", phone: "434-406-2189", email: "georduon@name.com", image: "demo/images/photos/x.png", itemTitleColor: "#4b0082" },
       { id: "8", parents: ["4", "5"], spouses: ["12", "13"], title: "John Green", label: "John Green", description: "8, Sr. VP, Software Core Operating System Division", phone: "937-475-8106", email: "johngree@name.com", image: "demo/images/photos/v.png", itemTitleColor: "#4b0082" },
       { id: "9", parents: ["4", "5"], spouses: ["14"], title: "Ralph Mercer", label: "Ralph Mercer", description: "9, GM, DML Server Strategy", phone: "814-327-5895", email: "ralpmerc@name.com", image: "demo/images/photos/c.png", itemTitleColor: "#4b0082" },
       { id: "10", parents: ["4", "5"], title: "Gil Adams", label: "Gil Adams", description: "10, GM, WW Licensing Programs", phone: "313-630-8717", email: "giladam@name.com", image: "demo/images/photos/z.png", itemTitleColor: "#4b0082" },
       { id: "11", parents: ["4", "5"], title: "Roger Greenlee", label: "Roger Greenlee", description: "11, Root item, it is placed close to its children.", phone: "847-510-2148", email: "rogegree@name.com", image: "demo/images/photos/w.png", itemTitleColor: "#ff0000" },
       { id: "12", title: "James Workman", label: "James Workman", description: "12, GM, Name Financing", phone: "713-624-6200", email: "jamework@name.com", image: "demo/images/photos/l.png", itemTitleColor: "#4b0082" },
       { id: "13", spouses: ["12"], title: "John Drake", label: "John Drake", description: "13, GM, Software Management", phone: "469-644-8543", email: "johndrak@name.com", image: "demo/images/photos/j.png", itemTitleColor: "#4b0082" },
       { id: "14", title: "Melvin White", label: "Melvin White", description: "14, GM, Real Time Collaboration & Home Entertainment Products", phone: "785-631-8548", email: "melvwhit@name.com", image: "demo/images/photos/u.png", itemTitleColor: "#4b0082" },
       { id: "15", parents: ["4", "5"], spouses: ["16"], title: "Jonathan Hitt", label: "Jonathan Hitt", description: "15, GM, BizTalk Server", phone: "443-591-0659", email: "jonahitt@name.com", image: "demo/images/photos/g.png", itemTitleColor: "#4b0082" },
       { id: "16", title: "Mary Spencer", label: "Mary Spencer", description: "16, GM, Manageability and Deployment", phone: "605-892-8662", email: "maryspen@name.com", image: "demo/images/photos/l.png", itemTitleColor: "#4b0082" },
       { id: "17", parents: ["15", "16"], spouses: ["20"], title: "Abbie Lawson", label: "Abbie Lawson", description: "17, Root item, it is placed close to its children.", phone: "530-322-6413", email: "abbilaws@name.com", image: "demo/images/photos/a.png", itemTitleColor: "#ff0000" },
       { id: "18", parents: ["16", "15"], title: "Nathalie Escobedo", label: "Nathalie Escobedo", description: "18, GM, DML Server Business Intelligence", phone: "504-555-8165", email: "nathesco@name.com", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
       { id: "19", parents: ["16", "15"], title: "Bonnie Wedel", label: "Bonnie Wedel", description: "19, VP, Enterprise Access and Security Products Division (EASP)", phone: "412-265-2782", email: "bonnwede@name.com", image: "demo/images/photos/i.png", itemTitleColor: "#4b0082" },
       { id: "20", title: "Jean Kendall", label: "Jean Kendall", description: "20, GM, DML Server Marketing", phone: "949-453-0415", email: "jeankend@name.com", image: "demo/images/photos/d.png", itemTitleColor: "#4b0082" },
       { id: "21", parents: ["10"], title: "Nancy Smith", label: "Nancy Smith", description: "21, GM, Strategic Marketing and Communications", phone: "631-787-3495", email: "nancsmit@name.com", image: "demo/images/photos/s.png", itemTitleColor: "#4b0082" },
       { id: "22", title: "Stanley Weathers", label: "Stanley Weathers", description: "22, Managing Dir., India Development Center", phone: "734-482-1633", email: "stanweat@name.com", image: "demo/images/photos/y.png", itemTitleColor: "#4b0082" }
    ]
};

var famdataLoopsTest = {
    dotItemsInterval: 20,
    lineItemsInterval: 40,
    linesWidth: 1,
    linesColor: "black",
    ...
    annotations: [
        ...
        { annotationType: primitives.common.AnnotationType.Label, fromItem: 2, toItems: [5], title: "2->5" },
        ...
        { annotationType: primitives.common.AnnotationType.Label, fromItem: 9, toItems: [10], title: "9->10" },
        { annotationType: primitives.common.AnnotationType.Label, fromItem: 10, toItems: [9], title: "10->9" }
    ],
    items: [
        { id: 1, parents: [2, 6], title: "1", label: "1", description: "1", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 2, parents: [1, 5], title: "2", label: "2", description: "2", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 5, parents: [7], title: "5", label: "5", description: "5", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 6, parents: [], title: "6", label: "6", description: "6", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 7, parents: [8], title: "7", label: "7", description: "7", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 8, title: "8", label: "8", description: "8", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 9, parents: [10], title: "9", label: "9", description: "9", image: "demo/images/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 10, parents: [9], title: "10", label: "10", description: "10", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" }
    ]
};
...
var famdataCharless2 = {
    ...
    items: [
        { id: 1, title: "Philip of Castile", label: "Philip of Castile", description: "1, 1478-1506", image: "demo/images/photos/p.png", itemTitleColor: "#ff0000" },
        { id: 2, title: "Joanna of Castile", label: "Joanna of Castile", description: "2, 1479-1555", image: "demo/images/photos/j.png", itemTitleColor: "#4b0082" },
        { id: 3, parents: [1, 2], title: "Charles V", label: "Charles V", description: "3, Holy Roman Emperor", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 4, title: "Isabella of Portugal", label: "Isabella of Portugal", description: "4, 1503 - 39", image: "demo/images/photos/i.png", itemTitleColor: "#4b0082" },
        { id: 5, parents: [3, 4], title: "Philip II of Spain", label: "Philip II of Spain", description: "5, ", image: "demo/images/photos/p.png", itemTitleColor: "#4b0082" },
        { id: 6, parents: [3, 4], title: "Maria of Spain", label: "Maria of Spain", description: "6, 1528 - 1603", image: "demo/images/photos/j.png", itemTitleColor: "#ff0000" },
        { id: 7, parents: [1, 2], title: "Ferdinand I", label: "Ferdinand I", description: "7, Holy Roman Emperor, 1503-64", image: "demo/images/photos/h.png", itemTitleColor: "#ff0000" },
        { id: 8, parents: [1, 2], title: "Isabella of Burgundy", label: "Isabella of Burgundy", description: "8, 1501-26", image: "demo/images/photos/h.png", itemTitleColor: "#ff0000" },
        { id: 9, title: "Anna of Bohemia and Hungary", label: "Anna of Bohemia and Hungary", description: "9, 1503-47", image: "demo/images/photos/i.png", itemTitleColor: "#4b0082" },
        { id: 10, title: "Christian II of Denmark", label: "Christian II of Denmark", description: "10, 1481-1559", image: "demo/images/photos/i.png", itemTitleColor: "#4b0082" },
        { id: 11, parents: [7, 9], title: "Maximilian II", label: "Maximilian II", description: "11, Holy Roman Emperor 1527-76", image: "demo/images/photos/h.png", itemTitleColor: "#ff0000" },
        { id: 12, parents: [7, 9], title: "Charles II of Austria", label: "Charles II of Austria", description: "12, 1540-90", image: "demo/images/photos/h.png", itemTitleColor: "#ff0000" },
        { id: 13, parents: [7, 9], title: "Anne of Habsburg", label: "Anne of Habsburg", description: "13, 1528-90", image: "demo/images/photos/a.png", itemTitleColor: "#ff0000" },
        { id: 14, title: "Albert V", label: "Albert V", description: "14, Duke of Bavaria 1528-79", image: "demo/images/photos/i.png", itemTitleColor: "#4b0082" },
        { id: 15, parents: [8, 10], title: "Christina of Denmark", label: "Christina of Denmark", description: "13, 1522-90", image: "demo/images/photos/a.png", itemTitleColor: "#ff0000" },
        { id: 16, title: "Francis I", label: "Francis I", description: "14, Duke of Lorraine 1517-45", image: "demo/images/photos/i.png", itemTitleColor: "#4b0082" },
        { id: 17, parents: [6, 11], title: "Anne of Austria", label: "Anne of Austria", description: "17, 1549-80", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 18, parents: [5, 17], title: "Philip III of Spain", label: "Philip III of Spain", description: "18, 1578-1621", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 19, parents: [13, 14], title: "Maria Anna of Bavaria", label: "Maria Anna of Bavaria", description: "19, 1551-1608", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 20, parents: [13, 14], title: "William V, Duke of Bavaria", label: "William V, Duke of Bavaria", description: "20, 1548-1626", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 21, parents: [15, 16], title: "Renata of Lorraine", label: "Renata of Lorraine", description: "21, 1544-1602", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 22, parents: [12, 19], title: "Margarita of Austria", label: "Margarita of Austria", description: "22, 1584-1611", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 23, parents: [12, 19], title: "Ferdinand II", label: "Ferdinand II", description: "23, Holy Roman Emperor 1578-1637", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 24, parents: [20, 21], title: "Maria Anna of Bavaria", label: "Maria Anna of Bavaria", description: "24, 1574-1616", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 25, parents: [18, 22], title: "Philip IV of Spain", label: "Philip IV of Spain", description: "25, 1605-65", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 26, parents: [18, 22], title: "Maria Anna of Spain", label: "Maria Anna of Spain", description: "26, 1606-46", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 27, parents: [23, 24], title: "Ferdinand III", label: "Ferdinand III", description: "27, 1608-57", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
        { id: 28, parents: [26, 27], title: "Manata of Austria", label: "Manata of Austria", description: "28, 1634-96", image: "demo/images/photos/c.png", itemTitleColor: "#ff0000" },
...
var dataSetNames = {
    ...
    skippedMembers: "Skipped Members",
    horizontalChain: "Horizontal Chain",
    alignmentData: "Alignment",
    famdataCascade: "Cascade",
    //famdataOwnership: "Weird Financial Ownership",
    famdataLoops: "Loops",
    famdataLoopsTest: "Lables on Loops",
    famdataWorld: "World Dynamics",
    famSpouses: "Spouses",
    famdataCharless2: "Inter Marriage"
}