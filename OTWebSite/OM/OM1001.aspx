<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OM1001.aspx.vb" Inherits="OM_OM1001" %>
...
<head id="Head1" runat="server">
    ...
    <!--
        ...
        function ActionVisable() {
            var btn = window.parent.frames[0].document.getElementById("ucButtonPermission_btnAdd");
        ...
        function BossCheck() {
            if (!confirm('當日已有部門主管異動資料存在，是否覆蓋？'))
                return false;
            document.getElementById("btnBoss").click();
        }
        function BossSave() {
            document.getElementById("btnBossSave").click();
        }
...
<body style="font-family:@微軟正黑體; margin-top: 5px; margin-left: 5px; margin-right: 5px; margin-bottom: 0">
            ...
            <td>
                <table id="Panel0" runat="server" width="100%">
                    <tr style="height: 20px">
                        ...
                        <td class="style1" style="width: 15%" align="center">
                            <asp:Label ID="lblOrganReason" ForeColor="Blue" runat="server" Text="*異動原因" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                    ...
                    Style="text-transform: uppercase" Width="200px" AutoPostBack="True" ></asp:TextBox>--%>
                            <asp:TextBox ID="txtOrganID" runat="server" MaxLength="12" CssClass="InputTextStyle_Thin"
                                Style="text-transform: uppercase" Width="200px" ></asp:TextBox>
                            <ajaxToolkit:FilteredTextBoxExtender ID="ftxtOrganID" runat="server" TargetControlID="txtOrganID"
                ...
                <ContentTemplate>--%>
                        ...
                        <td class="style1" align="center">
                            <asp:Label ID="lblOrganName" ForeColor="Blue" runat="server" Text="*部門名稱" ></asp:Label>
                        </td>
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblUpOrganID" ForeColor="Blue" runat="server" Text="*上階部門" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                            <asp:DropDownList ID="ddlUpOrganID" runat="server"  Width="295px">
                            </asp:DropDownList>
                        </td>
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblGroupType" runat="server" ForeColor="Blue" Text="*事業群類別" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblDeptID" runat="server" ForeColor="Blue" Text="*所屬一級部門" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                            <asp:DropDownList ID="ddlDeptID" runat="server" Width="295px">
                            </asp:DropDownList>
                        </td>
                        <td class="style1" width="15%" align="center">
                            <%--<asp:Label ID="lblRoleCode" runat="server" ForeColor="Blue" Text="*部門主管角色" ></asp:Label>--%>
                        </td>
                        <td class="style2" width="35%" align="left">
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblBoss" runat="server" ForeColor="Blue" Text="*部門主管" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                            ...
                            <%--<asp:PostBackTrigger  ControlID="ddlBossCompID" />
                            <asp:PostBackTrigger  ControlID="txtBoss" />--%>
                            </Triggers>
                            </asp:UpdatePanel>
                            <asp:Button ID="btnBoss" runat="server" Text="btnBoss"  Style="display: none"/>
                            <asp:Button ID="btnBossSave" runat="server" Text="btnBossSave" Style="display: none"/>
                        </td>
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblBossType" runat="server" ForeColor="Blue" Text="*主管任用方式" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblSecBoss" runat="server" Text="副主管" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                        ...
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblBossTemporary" runat="server" Text="主管暫代" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
        ...
        <tr>
            <td>
                <table align="center" runat="server" id="Panel1" width="100%">
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblPersonPart" runat="server" Text="人事管理員" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                            ...
                            <uc:ButtonQuerySelectUserID ID="ucPersonPart" runat="server"  WindowHeight="800"
                                WindowWidth="600" />
                        ...
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblWorkSiteID" ForeColor="Blue" runat="server"  Text="*工作地點"></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="Label25" runat="server" Text="自行查核主管" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
            ...
            <asp:TextBox ID="txtCheckPart" CssClass="InputTextStyle_Thin" runat="server" MaxLength="6"
                            ...
                            <uc:ButtonQuerySelectUserID ID="ucCheckPart" runat="server"  WindowHeight="800"
                                WindowWidth="600" />
            ...
            <Triggers>
                ...
                <%--<asp:AsyncPostBackTrigger ControlID ="ddlPositionID" />--%>
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblCostDeptID" runat="server" Text="費用分攤部門" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                            <asp:DropDownList ID="ddlCostDeptID" runat="server" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblWorkTypeID" ForeColor="Blue" runat="server" Text="*工作性質" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
            ...
            <Triggers>
                <asp:PostBackTrigger  ControlID="ucSelectWorkType"/>
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblAccountBranch" runat="server" Text="會計分行別" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                        ...
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblCostType" runat="server" Text="費用分攤科目別" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                    ...
                    <td class="style1" width="15%" align="center">
                        ...
                        <asp:Label ID="lblRoleCode" runat="server" align="center" ForeColor="Blue" 
                            Text="*部門主管角色"></asp:Label>
                    ...
                    <td class="style1" width="15%" align="center"></td>
                    <td class="style2" width="35%" align="left"></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <table align="center" runat="server" id="Panel2" width="100%">
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblFlowOrganID" runat="server" Text="比對簽核單位" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                        <asp:UpdatePanel ID="updFlowOrganID" runat="server" UpdateMode="Conditional" >
            <ContentTemplate>
            <asp:DropDownList ID="ddlFlowOrganID" runat="server" AutoPostBack="True">
                            </asp:DropDownList>
            ...
            <Triggers>
                <asp:PostBackTrigger  ControlID="ucFlowOrgan"/>
                        ...
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="CompareFlag" runat="server" Text="HR內部比對單位註記" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                    ...
                    <tr style="height: 20px">
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblDelegateFlag" runat="server" Text="授權註記" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                            <asp:CheckBox ID="chkDelegateFlag" runat="server" Text="" />
                        </td>
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblOrganNo" runat="server" Text="處級單位註記" ></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                    ...
                    <tr style="height: 20px">
                        ...
                        <td class="style1" width="15%" align="center">
                            <asp:Label ID="lblFlowRoleCode" runat="server" align="center" ForeColor="Blue" 
                                Text="*部門主管角色"></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left">
                            <asp:DropDownList ID="ddlFlowRoleCode" runat="server">
                            </asp:DropDownList>
                        </td>
                        <td class="style1" width="15%" align="center" id="tdBusinessType1">
                            <asp:Label ID="Label32" runat="server" Text="*業務類別" ForeColor="Blue"></asp:Label>
                        </td>
                        <td class="style2" width="35%" align="left" id="tdBusinessType2">
        ...
        <tr>
            <td>
                <table align="center" runat="server" id="Panel4">
                    <tr>
                        <td align="center" class="style1" width="35%">
                            <asp:Label ID="UpOrganName" runat="server" Text="" ></asp:Label>
                            <br />
                            <asp:Label ID="UpTitle" runat="server" Text="" ></asp:Label>
                            <br />
                            <asp:Label ID="UpRank" runat="server" Text="" ></asp:Label>
                            <br />
                            <asp:Label ID="UpBossID" runat="server" Text="" ></asp:Label>
                            <br />
                            <asp:Label ID="UpBossName" runat="server" Text="" ></asp:Label>
                    ...
                    <tr>
                        <td align="center" class="style1" width="35%">
                            <asp:Label ID="OrganName" runat="server" Text="" ></asp:Label>
                            <br />
                            <asp:Label ID="Title" runat="server" Text="" ></asp:Label>
                            <br />
                            <asp:Label ID="Rank" runat="server" Text="" ></asp:Label>
                            <br />
                            <asp:Label ID="BossID" runat="server" Text="" ></asp:Label>
                            <br />
                            <asp:Label ID="BossName" runat="server" Text="" ></asp:Label>
    ...
    <%--<asp:PostBackTrigger ControlID ="txtOrganID" />--%>
    <asp:PostBackTrigger ControlID ="btnBoss" />
    <asp:PostBackTrigger ControlID ="ddlOrganType" />
     <asp:PostBackTrigger ControlID ="ddlOrganReason" />
    <asp:PostBackTrigger ControlID ="ucValidDate" />
    <asp:PostBackTrigger ControlID ="btnValidDate" />
