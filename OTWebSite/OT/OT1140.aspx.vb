...
Partial Class OT_OT1140
    ...
    Private Sub DoAdd()
        ...
        Me.TransferFramePage("~/OT/OT1141.aspx", New ButtonState() {btnA, btnX, btnC}, _
    ...
    Private Sub DoUpdate()
        ...
        Me.TransferFramePage("~/OT/OT1142.aspx", New ButtonState() {btnU, btnX, btnC}, _
            ddlCompID.ID & "=" & strCompID, _
            txtEmpID.ID & "=" & txtEmpID.Text, _
            txtName.ID & "=" & txtName.Text, _
            "PageNo=" & pcMain.PageNo.ToString(), _
    ...
    Private Sub DoQuery()
        ...
        Try
            pcMain.DataTable = objOT.QueryEmpStockTrustExLevelSetting(
                "CompID=" & strCompID, _
    ...
    Private Sub DoDelete()
        ...
        Else
            ...
            beEmpStockTrustExLevel.CompID.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("CompID").ToString()
            beEmpStockTrustExLevel.EmpID.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("EmpID").ToString()

            Try
                objOT.DeleteEmpStockTrustExLevelSetting(beEmpStockTrustExLevel)
            Catch ex As Exception
    ...
    Protected Sub gvMain_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvMain.RowCommand
        If e.CommandName = "Detail" Then
            ...
            Me.TransferFramePage("~/OT/OT1142.aspx", New ButtonState() {btnX}, _
                ddlCompID.ID & "=" & strCompID, _
                txtEmpID.ID & "=" & txtEmpID.Text, _
                txtName.ID & "=" & txtName.Text, _
                "PageNo=" & pcMain.PageNo.ToString(), _
