<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OT1140.aspx.vb" Inherits="OT_OT1140" %>
                    ...
                    <table cellpadding="1" cellspacing="1" border="0" class="tbl_Condition" height="100%" width="100%">
                        <tr>
                            ...
                            <td align="left" width="30%">
                                <asp:TextBox CssClass="InputTextStyle_Thin" ID="txtEmpID" runat="server"></asp:TextBox>
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="CompID,EmpID,NameN" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Uamount" HeaderText="上限金額" ReadOnly="True" SortExpression="Uamount" >
