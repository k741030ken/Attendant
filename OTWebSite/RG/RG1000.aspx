<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RG1000.aspx.vb" Inherits="RG_RG1000" %>
...
<head runat="server">
    ...
    <!--
        function funAction(Param)
        {
            ...
            {
                case "btnDelete":
                    var test = document.getElementById("<%= gvMain.ClientID %>");
                    var rowIndex = parseInt(document.getElementById('__SelectedRowgvMain').value) + 1;
                    if (!confirm("※刪除員工資料會連帶刪除保險相關資料、簽核資料、學歷資料、前職資料、家庭資料、通訊資料...\n※您確定要刪除「" + test.rows(rowIndex).cells[2].innerText + "-" + test.rows(rowIndex).cells[3].innerText + "」員工資料？"))
                        return false;
                    break;
            }
        }
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="CompID,EmpID,EmpDate,NameN,IDNo" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
