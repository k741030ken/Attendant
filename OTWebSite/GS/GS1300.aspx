<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GS1300.aspx.vb" Inherits="GS_GS1300" %>
                            ...
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowSorting="True" 
                                    AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" 
                                              DataKeyNames="CompID,EmpID" Width="100%" PageSize="15" 
                                    HeaderStyle-ForeColor="dimgray" Font-Names="微軟正黑體">
                                    ...
                                    <Columns>                   
                                        <asp:BoundField DataField="Grade2" HeaderText="核定考績">
                                            ...
                                            <ItemStyle Width="4%" CssClass="td_detail" HorizontalAlign="Center" Font-Names="微軟正黑體" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="GradeOrderDept" HeaderText="年度排序" SortExpression="GradeOrderDept">
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Left" Width="4%" Font-Names="微軟正黑體" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="Position" HeaderText="職位" SortExpression="Position" >
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Center" Width="12%" Font-Names="微軟正黑體" />
                                        </asp:BoundField>
                                    ...
                                    <HeaderStyle ForeColor="DimGray" Font-Names="微軟正黑體"></HeaderStyle>
