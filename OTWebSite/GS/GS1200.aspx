<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GS1200.aspx.vb" Inherits="GS_GS1200" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
            <tr>
                <td align="left" width="100%">
                    ...
                    <%--<asp:Label ID="lblGradeOrderHR" runat="server" Text="銀行初核：" style="margin-left:30px;"></asp:Label>--%>
                                <asp:Label ID="txtGradeOrderHR" runat="server" Text="" Font-Names="微軟正黑體"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="left" width="100%">
                    <asp:Label ID="lblGroup" runat="server" Text="群組：" Font-Names="微軟正黑體"></asp:Label>
                    <asp:RadioButton ID="rbnGroup3" GroupName="rbnGroupType" runat="server" Text="單位主管" Font-Names="微軟正黑體" AutoPostBack="true" />
                    <asp:RadioButton ID="rbnGroup2" GroupName="rbnGroupType" runat="server" Text="科主管"  Font-Names="微軟正黑體" AutoPostBack="true" />
                    <asp:RadioButton ID="rbnGroup1" GroupName="rbnGroupType" runat="server" Text="非管理職" Font-Names="微軟正黑體" AutoPostBack="true" />   
                    ...
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td align="left" style="font-family:@微軟正黑體">                               
                                ...
                                <img border="0" src="../images/information.png"><asp:Label ID="Label5" runat="server" Text="考績補充說明" Font-Names="微軟正黑體"></asp:Label>
                            ...
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="GradeDept" HeaderText="考績檢核用">
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle Width="5%" CssClass="td_detail" HorizontalAlign="Center" Font-Names="微軟正黑體" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="初排序">
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle Width="3%" CssClass="td_detail" HorizontalAlign="Right" Font-Names="微軟正黑體" />
                                            <ItemTemplate><%# DataBinder.Eval(Container.DataItem, "GradeOrderDept")%>/<%# DataBinder.Eval(Container.DataItem, "DeptCnt")%></ItemTemplate>
                                        </asp:TemplateField>                                        
                                        <asp:BoundField DataField="OrganName" HeaderText="單位分行">
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle Width="7%" CssClass="td_detail" HorizontalAlign="Center" Font-Names="微軟正黑體" />
                                        </asp:BoundField>                                        
                                        ...
                                        <asp:BoundField DataField="Position" HeaderText="職位" SortExpression="Position" >
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle Width="9%" CssClass="td_detail" HorizontalAlign="Center" Font-Names="微軟正黑體" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="RankID" HeaderText="職等" SortExpression="RankID" >
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle Width="3%" CssClass="td_detail" HorizontalAlign="Center" Font-Names="微軟正黑體" />
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="參考資料">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="ibtnComment" runat="server" CausesValidation="false" CommandName="Comment" ImageUrl="../images/information.png" ToolTip="考績補充說明" Visible="false"></asp:ImageButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="Memo" HeaderText="備註">
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle Width="10%" CssClass="td_detail" HorizontalAlign="Left" Font-Names="微軟正黑體" />
                                        </asp:BoundField>
