<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GS1400.aspx.vb" Inherits="GS_GS1400" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
            <tr>
                <td align="left" width="100%">
                    ...
                    <asp:Label ID="lblGradeOrderHR" runat="server" Text="" style="margin-left:30px;" Font-Names="微軟正黑體"></asp:Label>
                            ...
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Grade" HeaderText="考績配置">
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle Width="5%" CssClass="td_detail" HorizontalAlign="Center" Font-Names="微軟正黑體" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="GradeOrder" HeaderText="排序" SortExpression="GradeOrder">
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Left" Width="5%" Font-Names="微軟正黑體" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Grade2" HeaderText="核定考績">
                                            <HeaderStyle CssClass="td_header" VerticalAlign="Middle" Font-Names="微軟正黑體" />
                                        ...
                                        <asp:TemplateField HeaderText="參考資料">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="ibtnComment" runat="server" CausesValidation="false" CommandName="Comment" ImageUrl="../images/information.png" ToolTip="考核補充說明" Visible="false"></asp:ImageButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
