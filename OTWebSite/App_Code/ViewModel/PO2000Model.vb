...
Public Class PO2000Model
    ...
    Private _po2000GridData As List(Of PO2000GridData)
    ''' <summary>
    ''' 公司ID
    ''' </summary>
    ...
    ''' Grid Data(List)
    ''' </summary>
    Public Property PO2000GridDataList As List(Of PO2000GridData)
        Get
            Return _po2000GridData
        End Get
        Set(ByVal value As List(Of PO2000GridData))
            _po2000GridData = value
        End Set
    End Property
End Class
