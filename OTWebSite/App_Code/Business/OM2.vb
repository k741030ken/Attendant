...
#Region "查詢"
    '行政組織-查詢Organization leo-20161222 modify   like UPPER
    ...
    End Function
    '功能組織-查詢OrganizationFlow leo-20161222 modify   like UPPER
    Public Function OM2000QueryOrganizationFlow(ByVal ParamArray Params() As String) As DataTable
        ...
        Return Bsp.DB.ExecuteDataSet(CommandType.Text, strSQL.ToString(), "eHRMSDB").Tables(0)
    End Function
    '行政、功能組織-查詢OrganizationAndOrganizationFlow leo-20161222 modify   like UPPER
    ...
    '歷任主管紀錄查詢(歷任行政) leo-20161222 modify 現+歷 order by desc
    Public Function OM2000QueryOrganizationBossLogPast(ByVal CompID As String, ByVal OrganID As String) As DataTable
        ...
        strSQL.AppendLine(" ORDER BY O.ValidDateBH desc")
...
#Region "下傳"
    '取得查詢結果(FOR行政下傳) leo-20161222 modify   like UPPER
    ...
    '取得查詢結果(FOR功能下傳)leo-20161222 modify   like UPPER
    ...
    Public Function GetOrganizationFlowInfoByDownload(Optional ByVal FieldNames As String = "*", Optional ByVal CondStr As String = "") As DataTable
        ...
        '所屬事業群名稱
        strSQL.AppendLine(" Left Join OrganizationFlow AS OrgF2 On OrgF.GroupID = OrgF2.OrganID ")
        '上階部門名稱
