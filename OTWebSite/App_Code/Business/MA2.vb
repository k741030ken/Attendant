...
#Region "是否有權限查詢重要資料"
    Public Function GetQueryFlag(ByVal CompID As String, ByVal UserID As String, ByVal CompRoleID As String, ByVal SysID As String) As Boolean
        Dim strSQL As New StringBuilder()

        strSQL.AppendLine("Select Count(*) As Cnt From SC_GroupMutiQry")
        strSQL.AppendLine("Where 1 = 1")
