...
Public Class OV1_OVA
    Public Property OTCompID As String
    Public Property OTEmpID As String
    Public Property OTStartDate As String
    Public Property OTEndDate As String
    Public Property OTSeq As String
    Public Property OTTxnID As String
    Public Property OTSeqNo As String
    ...
    Public Property OTTotalTime As String
    ...
    Public Property OTReasonID As String
    Public Property OTReasonMemo As String
    Public Property OTAttachment As String
    Public Property OTFormNO As String
    Public Property OTRegisterID As String
    Public Property OTRegisterDate As String
    Public Property OTStatus As String
    Public Property HolidayOrNot As String
    Public Property OTValidDate As String
    Public Property OTValidID As String
    Public Property OTRejectDate As String
    Public Property OTRejectID As String
    Public Property OTGovernmentNo As String
