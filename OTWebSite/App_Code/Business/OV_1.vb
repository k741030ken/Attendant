...
#End Region
    ...
    Public Function isNull(ByVal strPro As String) As Boolean
        Dim myType As Type = GetType(OV_1)
...
#End Region
    ...
    End Function
#Region "4002資料更新"
    Public Function DeleteFor4002(ByVal OV_1 As OV_1, ByVal OTSeqNo As String) As Boolean
        ...
        SQLString.AppendLine(" WHERE OTTxnID=" + Bsp.Utility.Quote(OV_1.OTTxnID))
        SQLString.AppendLine(" and OTCompID=" + Bsp.Utility.Quote(OV_1.CompID))
        SQLString.AppendLine(" and OTEmpID=" + Bsp.Utility.Quote(OV_1.OTEmpID))
        ...
        Return Flag
    End Function
    Public Function InsertFor4002OVA(ByVal OV_1 As OV_1, ByVal oldOVAData As OV4_OVA) As Boolean
        Dim SQLString As StringBuilder = New StringBuilder
        '拆單
        Dim StartDate1 As String = OV_1.OvertimeDateB
        Dim EndDate1 As String = OV_1.OvertimeDateB
        Dim StartTime1 As String = OV_1.OTStartTime
        Dim EndTime1 As String = "2359"

        Dim StartDate2 As String = OV_1.OvertimeDateE
        Dim EndDate2 As String = OV_1.OvertimeDateE
        Dim StartTime2 As String = "0000"
        Dim EndTime2 As String = OV_1.OTEndTime
        ...
        Dim Flag As Boolean = False
        Dim mealFlag1 As String = OV_1.mealFlag
        Dim mealFlag2 As String = OV_1.mealFlag
        Dim mealTime1 As String
        Dim mealTime2 As String
        Dim HolidayOrNot1 As String = If(Me.CheckHolidayOrNot(OV_1.OvertimeDateB), "1", "0")
        Dim HolidayOrNot2 As String = If(Me.CheckHolidayOrNot(OV_1.OvertimeDateE), "1", "0")
        ...
        If Convert.ToInt32(OTTotalTime1) < Convert.ToInt32(OV_1.mealTime) Then
            mealTime1 = (Convert.ToInt32(OTTotalTime1)).ToString
            mealTime2 = (Convert.ToInt32(OV_1.mealTime) - Convert.ToInt32(OTTotalTime1)).ToString
        Else
            mealTime1 = (Convert.ToInt32(OV_1.mealTime)).ToString
            mealTime2 = "0"
        End If
        ...
        SQLString.AppendLine("," + Bsp.Utility.Quote(OV_1.SalaryOrAdjust) + "," + Bsp.Utility.Quote(OV_1.AdjustInvalidDate) + "," + Bsp.Utility.Quote(mealFlag1))
        SQLString.AppendLine("," + Bsp.Utility.Quote(mealTime1) + "," + Bsp.Utility.Quote(OV_1.OTTypeID) + "," + Bsp.Utility.Quote(oldOVAData.OTReasonID))
        SQLString.AppendLine("," + Bsp.Utility.Quote(OV_1.OTReasonMemo) + "," + Bsp.Utility.Quote(OV_1.OTAttachment) + "," + Bsp.Utility.Quote(oldOVAData.OTFormNO))
        ...
        SQLString.AppendLine("," + Bsp.Utility.Quote(OV_1.LastChgComp) + "," + Bsp.Utility.Quote(OV_1.LastChgID) + ", getdate()," + Bsp.Utility.Quote(oldOVAData.OTRegisterComp) + ")")
        ...
        SQLString.AppendLine("," + Bsp.Utility.Quote(OV_1.SalaryOrAdjust) + "," + Bsp.Utility.Quote(OV_1.AdjustInvalidDate) + "," + Bsp.Utility.Quote(mealFlag2))
        SQLString.AppendLine("," + Bsp.Utility.Quote(mealTime2) + "," + Bsp.Utility.Quote(OV_1.OTTypeID) + "," + Bsp.Utility.Quote(oldOVAData.OTReasonID))
        SQLString.AppendLine("," + Bsp.Utility.Quote(OV_1.OTReasonMemo) + "," + Bsp.Utility.Quote(OV_1.OTAttachment) + "," + Bsp.Utility.Quote(oldOVAData.OTFormNO))
        SQLString.AppendLine("," + Bsp.Utility.Quote(oldOVAData.OTRegisterID) + "," + Bsp.Utility.Quote(oldOVAData.OTRegisterDate) + "," + Bsp.Utility.Quote(oldOVAData.OTStatus))
    ...
    Public Function InsertFor4002OVD(ByVal OV_1 As OV_1, ByVal oldOVDData As OV4_OVD) As Boolean
        Dim SQLString As StringBuilder = New StringBuilder
        '拆單
        Dim StartDate1 As String = OV_1.OvertimeDateB
        Dim EndDate1 As String = OV_1.OvertimeDateB
        ...
        If "2".Equals(OV_1.SalaryOrAdjust) And "after".Equals(Type) And OV_1.isSalaryPaid Then
        ...
        SQLString.AppendLine("," + Bsp.Utility.Quote(StartTime1) + "," + Bsp.Utility.Quote(EndTime1) + "," + Bsp.Utility.Quote(OTTotalTime1))
        SQLString.AppendLine("," + Bsp.Utility.Quote(OV_1.SalaryOrAdjust) + "," + Bsp.Utility.Quote(OV_1.AdjustInvalidDate))
        ...
        SQLString.AppendLine("," + Bsp.Utility.Quote(mealTime1) + "," + Bsp.Utility.Quote(OV_1.OTTypeID) + "," + Bsp.Utility.Quote(oldOVDData.OTReasonID))
        SQLString.AppendLine("," + Bsp.Utility.Quote(OV_1.OTReasonMemo) + "," + Bsp.Utility.Quote(OV_1.OTAttachment) + "," + Bsp.Utility.Quote(oldOVDData.OTFormNO))
        ...
        SQLString.AppendLine("," + Bsp.Utility.Quote(OV_1.LastChgComp) + "," + Bsp.Utility.Quote(OV_1.LastChgID) + ", getdate()," + Bsp.Utility.Quote(oldOVDData.OTRegisterComp) + ")")
        ...
        SQLString.AppendLine("," + Bsp.Utility.Quote(mealTime2) + "," + Bsp.Utility.Quote(OV_1.OTTypeID) + "," + Bsp.Utility.Quote(oldOVDData.OTReasonID))
        SQLString.AppendLine("," + Bsp.Utility.Quote(OV_1.OTReasonMemo) + "," + Bsp.Utility.Quote(OV_1.OTAttachment) + "," + Bsp.Utility.Quote(oldOVDData.OTFormNO))
        SQLString.AppendLine("," + Bsp.Utility.Quote(oldOVDData.OTRegisterID) + "," + Bsp.Utility.Quote(oldOVDData.OTRegisterDate) + "," + Bsp.Utility.Quote(oldOVDData.OTStatus))
        SQLString.AppendLine("," + Bsp.Utility.Quote(oldOVDData.OTValidDate) + "," + Bsp.Utility.Quote(oldOVDData.OTValidID) + "," + Bsp.Utility.Quote(oldOVDData.OverTimeFlag))
        SQLString.AppendLine("," + Bsp.Utility.Quote(oldOVDData.ToOverTimeDate) + "," + Bsp.Utility.Quote(oldOVDData.ToOverTimeFlag) + "," + Bsp.Utility.Quote(oldOVDData.OTRejectDate))
    ...
    Public Function UpDateFor4002Single(ByVal OV_1 As OV_1) As Boolean
        Dim SQLString As StringBuilder = New StringBuilder
        Dim Flag As Boolean = False
        Dim DataTable As String
        If "bef".Equals(Type) Then
        ...
        SQLString.AppendLine("SET [OTStartDate] = " + Bsp.Utility.Quote(OV_1.OvertimeDateB))
        SQLString.AppendLine(",[OTEndDate] = " + Bsp.Utility.Quote(OV_1.OvertimeDateE))
        SQLString.AppendLine(",[OTStartTime] = " + Bsp.Utility.Quote(OV_1.OTStartTime))
        SQLString.AppendLine(",[OTEndTime] = " + Bsp.Utility.Quote(OV_1.OTEndTime))
        SQLString.AppendLine(",[OTTotalTime] =" + Bsp.Utility.Quote(OV_1.Time))
        SQLString.AppendLine(",[SalaryOrAdjust] = " + Bsp.Utility.Quote(OV_1.SalaryOrAdjust))
        SQLString.AppendLine(",[AdjustInvalidDate] = " + Bsp.Utility.Quote(OV_1.AdjustInvalidDate))
        SQLString.AppendLine(",[HolidayOrNot] = " + Bsp.Utility.Quote(HolidayOrNot1))

        If isNull("mealFlag") Then
            SQLString.AppendLine(",[MealFlag] = " + Bsp.Utility.Quote(OV_1.mealFlag))
        End If
        If isNull("mealTime") Then
            SQLString.AppendLine(",[MealTime] =" + Bsp.Utility.Quote(OV_1.mealTime))
        End If
        SQLString.AppendLine(",[OTTypeID] =" + Bsp.Utility.Quote(OV_1.OTTypeID))
        If isNull("OTReasonMemo") Then
            SQLString.AppendLine(",[OTReasonMemo] =" + Bsp.Utility.Quote(OV_1.OTReasonMemo))
        End If
        ...
        SQLString.AppendLine(",[OTAttachment] =" + Bsp.Utility.Quote(OV_1.OTAttachment))


        SQLString.AppendLine(",[OTSeq] =" + Bsp.Utility.Quote(QuerySeq(DataTable, Me.OTEmpID, Me.OvertimeDateB)))
        SQLString.AppendLine(",[LastChgComp] =" + Bsp.Utility.Quote(OV_1.LastChgComp))
        SQLString.AppendLine(",[LastChgID] =" + Bsp.Utility.Quote(OV_1.LastChgID))
