...
Namespace beEmpAddition
    Public Class Table
        ...
        Public ReadOnly Property Rows() As beEmpAddition.Rows 
            Get
                Return m_Rows
            End Get
        End Property
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub Transfer2Row(EmpAdditionTable As DataTable)
            For Each dr As DataRow In EmpAdditionTable.Rows
    ...
    Public Class Rows
        ...
        Public Sub Add(EmpAdditionRow As Row)
            m_Rows.Add(EmpAdditionRow)
        End Sub

        Public Sub Remove(EmpAdditionRow As Row)
            If m_Rows.IndexOf(EmpAdditionRow) >= 0 Then
                m_Rows.Remove(EmpAdditionRow)
            End If
        End Sub
    ...
    Public Class Service
        Public Function DeleteRowByPrimaryKey(ByVal EmpAdditionRow As Row) As Integer
            ...
            db.AddInParameter(dbcmd, "@ValidDate", DbType.Date, EmpAdditionRow.ValidDate.Value)
            db.AddInParameter(dbcmd, "@CompID", DbType.String, EmpAdditionRow.CompID.Value)
            db.AddInParameter(dbcmd, "@EmpID", DbType.String, EmpAdditionRow.EmpID.Value)
            db.AddInParameter(dbcmd, "@AddCompID", DbType.String, EmpAdditionRow.AddCompID.Value)
            db.AddInParameter(dbcmd, "@AddDeptID", DbType.String, EmpAdditionRow.AddDeptID.Value)
            db.AddInParameter(dbcmd, "@AddOrganID", DbType.String, EmpAdditionRow.AddOrganID.Value)

            return db.ExecuteNonQuery(dbcmd)
        End Function

        public Function DeleteRowByPrimaryKey(ByVal EmpAdditionRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function DeleteRowByPrimaryKey(ByVal EmpAdditionRow As Row()) As Integer
            ...
            using cn As DbConnection = db.CreateConnection()
                ...
                Try
                    For Each r As Row In EmpAdditionRow
        ...
        Public Function QueryByKey(ByVal EmpAdditionRow As Row) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Select * From EmpAddition")
            strSQL.AppendLine("Where ValidDate = @ValidDate")
            strSQL.AppendLine("And CompID = @CompID")
            strSQL.AppendLine("And EmpID = @EmpID")
            strSQL.AppendLine("And AddCompID = @AddCompID")
        ...
        Public Function QueryByKey(EmpAdditionRow As Row, tran As DbTransaction) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function Update(ByVal EmpAdditionRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim strDot As String = String.Empty

            strSQL.AppendLine("Update EmpAddition Set")
            For i As Integer = 0 To EmpAdditionRow.FieldNames.Length - 1
                If Not EmpAdditionRow.IsIdentityField(EmpAdditionRow.FieldNames(i)) AndAlso EmpAdditionRow.IsUpdated(EmpAdditionRow.FieldNames(i)) AndAlso EmpAdditionRow.CreateUpdateSQL(EmpAdditionRow.FieldNames(i)) Then
                    strSQL.AppendLine(string.Format("{0}{1} = @{1}", strDot, EmpAdditionRow.FieldNames(i)))
                    strDot = ","
                End If
            Next
            ...
            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            If EmpAdditionRow.ValidDate.Updated Then db.AddInParameter(dbcmd, "@ValidDate", DbType.Date, IIf(IsDateTimeNull(EmpAdditionRow.ValidDate.Value), Convert.ToDateTime("1900/1/1"), EmpAdditionRow.ValidDate.Value))
            If EmpAdditionRow.CompID.Updated Then db.AddInParameter(dbcmd, "@CompID", DbType.String, EmpAdditionRow.CompID.Value)
            If EmpAdditionRow.EmpID.Updated Then db.AddInParameter(dbcmd, "@EmpID", DbType.String, EmpAdditionRow.EmpID.Value)
            If EmpAdditionRow.AddCompID.Updated Then db.AddInParameter(dbcmd, "@AddCompID", DbType.String, EmpAdditionRow.AddCompID.Value)
            If EmpAdditionRow.AddDeptID.Updated Then db.AddInParameter(dbcmd, "@AddDeptID", DbType.String, EmpAdditionRow.AddDeptID.Value)
            If EmpAdditionRow.AddOrganID.Updated Then db.AddInParameter(dbcmd, "@AddOrganID", DbType.String, EmpAdditionRow.AddOrganID.Value)
            If EmpAdditionRow.AddFlowOrganID.Updated Then db.AddInParameter(dbcmd, "@AddFlowOrganID", DbType.String, EmpAdditionRow.AddFlowOrganID.Value)
            If EmpAdditionRow.Reason.Updated Then db.AddInParameter(dbcmd, "@Reason", DbType.String, EmpAdditionRow.Reason.Value)
            If EmpAdditionRow.FileNo.Updated Then db.AddInParameter(dbcmd, "@FileNo", DbType.String, EmpAdditionRow.FileNo.Value)
            If EmpAdditionRow.Remark.Updated Then db.AddInParameter(dbcmd, "@Remark", DbType.String, EmpAdditionRow.Remark.Value)
            If EmpAdditionRow.IsBoss.Updated Then db.AddInParameter(dbcmd, "@IsBoss", DbType.String, EmpAdditionRow.IsBoss.Value)
            If EmpAdditionRow.IsSecBoss.Updated Then db.AddInParameter(dbcmd, "@IsSecBoss", DbType.String, EmpAdditionRow.IsSecBoss.Value)
            If EmpAdditionRow.IsGroupBoss.Updated Then db.AddInParameter(dbcmd, "@IsGroupBoss", DbType.String, EmpAdditionRow.IsGroupBoss.Value)
            If EmpAdditionRow.IsSecGroupBoss.Updated Then db.AddInParameter(dbcmd, "@IsSecGroupBoss", DbType.String, EmpAdditionRow.IsSecGroupBoss.Value)
            If EmpAdditionRow.BossType.Updated Then db.AddInParameter(dbcmd, "@BossType", DbType.String, EmpAdditionRow.BossType.Value)
            If EmpAdditionRow.CreateDate.Updated Then db.AddInParameter(dbcmd, "@CreateDate", DbType.Date, IIf(IsDateTimeNull(EmpAdditionRow.CreateDate.Value), Convert.ToDateTime("1900/1/1"), EmpAdditionRow.CreateDate.Value))
            If EmpAdditionRow.CreateComp.Updated Then db.AddInParameter(dbcmd, "@CreateComp", DbType.String, EmpAdditionRow.CreateComp.Value)
            If EmpAdditionRow.CreateID.Updated Then db.AddInParameter(dbcmd, "@CreateID", DbType.String, EmpAdditionRow.CreateID.Value)
            If EmpAdditionRow.LastChgDate.Updated Then db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(EmpAdditionRow.LastChgDate.Value), Convert.ToDateTime("1900/1/1"), EmpAdditionRow.LastChgDate.Value))
            If EmpAdditionRow.LastChgComp.Updated Then db.AddInParameter(dbcmd, "@LastChgComp", DbType.String, EmpAdditionRow.LastChgComp.Value)
            If EmpAdditionRow.LastChgID.Updated Then db.AddInParameter(dbcmd, "@LastChgID", DbType.String, EmpAdditionRow.LastChgID.Value)
            db.AddInParameter(dbcmd, "@PKValidDate", DbType.Date, IIf(EmpAdditionRow.LoadFromDataRow, EmpAdditionRow.ValidDate.OldValue, EmpAdditionRow.ValidDate.Value))
            db.AddInParameter(dbcmd, "@PKCompID", DbType.String, IIf(EmpAdditionRow.LoadFromDataRow, EmpAdditionRow.CompID.OldValue, EmpAdditionRow.CompID.Value))
            db.AddInParameter(dbcmd, "@PKEmpID", DbType.String, IIf(EmpAdditionRow.LoadFromDataRow, EmpAdditionRow.EmpID.OldValue, EmpAdditionRow.EmpID.Value))
            db.AddInParameter(dbcmd, "@PKAddCompID", DbType.String, IIf(EmpAdditionRow.LoadFromDataRow, EmpAdditionRow.AddCompID.OldValue, EmpAdditionRow.AddCompID.Value))
            db.AddInParameter(dbcmd, "@PKAddDeptID", DbType.String, IIf(EmpAdditionRow.LoadFromDataRow, EmpAdditionRow.AddDeptID.OldValue, EmpAdditionRow.AddDeptID.Value))
            db.AddInParameter(dbcmd, "@PKAddOrganID", DbType.String, IIf(EmpAdditionRow.LoadFromDataRow, EmpAdditionRow.AddOrganID.OldValue, EmpAdditionRow.AddOrganID.Value))

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Update(ByVal EmpAdditionRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim strDot As String = String.Empty
        ...
        Public Function IsDataExists(ByVal EmpAdditionRow As Row) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0

            strSQL.AppendLine("Select Count(*) Cnt From EmpAddition")
            strSQL.AppendLine("Where ValidDate = @ValidDate")
            strSQL.AppendLine("And CompID = @CompID")
            strSQL.AppendLine("And EmpID = @EmpID")
            strSQL.AppendLine("And AddCompID = @AddCompID")
        ...
        Public Function IsDataExists(ByVal EmpAdditionRow As Row, ByVal tran As DbTransaction) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0
        ...
        Public Function Insert(ByVal EmpAdditionRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Insert into EmpAddition")
            strSQL.AppendLine("(")
            ...
            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            db.AddInParameter(dbcmd, "@ValidDate", DbType.Date, IIf(IsDateTimeNull(EmpAdditionRow.ValidDate.Value), Convert.ToDateTime("1900/1/1"), EmpAdditionRow.ValidDate.Value))
            db.AddInParameter(dbcmd, "@CompID", DbType.String, EmpAdditionRow.CompID.Value)
            db.AddInParameter(dbcmd, "@EmpID", DbType.String, EmpAdditionRow.EmpID.Value)
            db.AddInParameter(dbcmd, "@AddCompID", DbType.String, EmpAdditionRow.AddCompID.Value)
            db.AddInParameter(dbcmd, "@AddDeptID", DbType.String, EmpAdditionRow.AddDeptID.Value)
            db.AddInParameter(dbcmd, "@AddOrganID", DbType.String, EmpAdditionRow.AddOrganID.Value)
            db.AddInParameter(dbcmd, "@AddFlowOrganID", DbType.String, EmpAdditionRow.AddFlowOrganID.Value)
            db.AddInParameter(dbcmd, "@Reason", DbType.String, EmpAdditionRow.Reason.Value)
            db.AddInParameter(dbcmd, "@FileNo", DbType.String, EmpAdditionRow.FileNo.Value)
            db.AddInParameter(dbcmd, "@Remark", DbType.String, EmpAdditionRow.Remark.Value)
            db.AddInParameter(dbcmd, "@IsBoss", DbType.String, EmpAdditionRow.IsBoss.Value)
            db.AddInParameter(dbcmd, "@IsSecBoss", DbType.String, EmpAdditionRow.IsSecBoss.Value)
            db.AddInParameter(dbcmd, "@IsGroupBoss", DbType.String, EmpAdditionRow.IsGroupBoss.Value)
            db.AddInParameter(dbcmd, "@IsSecGroupBoss", DbType.String, EmpAdditionRow.IsSecGroupBoss.Value)
            db.AddInParameter(dbcmd, "@BossType", DbType.String, EmpAdditionRow.BossType.Value)
            db.AddInParameter(dbcmd, "@CreateDate", DbType.Date, IIf(IsDateTimeNull(EmpAdditionRow.CreateDate.Value), Convert.ToDateTime("1900/1/1"), EmpAdditionRow.CreateDate.Value))
            db.AddInParameter(dbcmd, "@CreateComp", DbType.String, EmpAdditionRow.CreateComp.Value)
            db.AddInParameter(dbcmd, "@CreateID", DbType.String, EmpAdditionRow.CreateID.Value)
            db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(EmpAdditionRow.LastChgDate.Value), Convert.ToDateTime("1900/1/1"), EmpAdditionRow.LastChgDate.Value))
            db.AddInParameter(dbcmd, "@LastChgComp", DbType.String, EmpAdditionRow.LastChgComp.Value)
            db.AddInParameter(dbcmd, "@LastChgID", DbType.String, EmpAdditionRow.LastChgID.Value)

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Insert(ByVal EmpAdditionRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
