...
Namespace beTmp_EmpAdditionWait
    Public Class Table
        ...
        Public ReadOnly Property Rows() As beTmp_EmpAdditionWait.Rows 
            Get
                Return m_Rows
            End Get
        End Property
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub Transfer2Row(Tmp_EmpAdditionWaitTable As DataTable)
            For Each dr As DataRow In Tmp_EmpAdditionWaitTable.Rows
    ...
    Public Class Rows
        ...
        Public Sub Add(Tmp_EmpAdditionWaitRow As Row)
            m_Rows.Add(Tmp_EmpAdditionWaitRow)
        End Sub

        Public Sub Remove(Tmp_EmpAdditionWaitRow As Row)
            If m_Rows.IndexOf(Tmp_EmpAdditionWaitRow) >= 0 Then
                m_Rows.Remove(Tmp_EmpAdditionWaitRow)
            End If
        End Sub
    ...
    Public Class Service
        Public Function DeleteRowByPrimaryKey(ByVal Tmp_EmpAdditionWaitRow As Row) As Integer
            ...
            db.AddInParameter(dbcmd, "@CompID", DbType.String, Tmp_EmpAdditionWaitRow.CompID.Value)
            db.AddInParameter(dbcmd, "@EmpID", DbType.String, Tmp_EmpAdditionWaitRow.EmpID.Value)
            db.AddInParameter(dbcmd, "@ValidDate", DbType.Date, Tmp_EmpAdditionWaitRow.ValidDate.Value)
            db.AddInParameter(dbcmd, "@Seq", DbType.Int32, Tmp_EmpAdditionWaitRow.Seq.Value)
            db.AddInParameter(dbcmd, "@AddSeq", DbType.Int32, Tmp_EmpAdditionWaitRow.AddSeq.Value)

            return db.ExecuteNonQuery(dbcmd)
        End Function

        public Function DeleteRowByPrimaryKey(ByVal Tmp_EmpAdditionWaitRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function DeleteRowByPrimaryKey(ByVal Tmp_EmpAdditionWaitRow As Row()) As Integer
            ...
            using cn As DbConnection = db.CreateConnection()
                ...
                Try
                    For Each r As Row In Tmp_EmpAdditionWaitRow
        ...
        Public Function QueryByKey(ByVal Tmp_EmpAdditionWaitRow As Row) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Select * From Tmp_EmpAdditionWait")
            strSQL.AppendLine("Where CompID = @CompID")
            strSQL.AppendLine("And EmpID = @EmpID")
            strSQL.AppendLine("And ValidDate = @ValidDate")
            strSQL.AppendLine("And Seq = @Seq")
        ...
        Public Function QueryByKey(Tmp_EmpAdditionWaitRow As Row, tran As DbTransaction) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function Update(ByVal Tmp_EmpAdditionWaitRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            ...
            For i As Integer = 0 To Tmp_EmpAdditionWaitRow.FieldNames.Length - 1
                If Not Tmp_EmpAdditionWaitRow.IsIdentityField(Tmp_EmpAdditionWaitRow.FieldNames(i)) AndAlso Tmp_EmpAdditionWaitRow.IsUpdated(Tmp_EmpAdditionWaitRow.FieldNames(i)) AndAlso Tmp_EmpAdditionWaitRow.CreateUpdateSQL(Tmp_EmpAdditionWaitRow.FieldNames(i)) Then
                    strSQL.AppendLine(string.Format("{0}{1} = @{1}", strDot, Tmp_EmpAdditionWaitRow.FieldNames(i)))
                    strDot = ","
                End If
            Next
            ...
            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            If Tmp_EmpAdditionWaitRow.CompID.Updated Then db.AddInParameter(dbcmd, "@CompID", DbType.String, Tmp_EmpAdditionWaitRow.CompID.Value)
            If Tmp_EmpAdditionWaitRow.EmpID.Updated Then db.AddInParameter(dbcmd, "@EmpID", DbType.String, Tmp_EmpAdditionWaitRow.EmpID.Value)
            If Tmp_EmpAdditionWaitRow.ValidDate.Updated Then db.AddInParameter(dbcmd, "@ValidDate", DbType.Date, IIf(IsDateTimeNull(Tmp_EmpAdditionWaitRow.ValidDate.Value), Convert.ToDateTime("1900/1/1"), Tmp_EmpAdditionWaitRow.ValidDate.Value))
            If Tmp_EmpAdditionWaitRow.Seq.Updated Then db.AddInParameter(dbcmd, "@Seq", DbType.Int32, Tmp_EmpAdditionWaitRow.Seq.Value)
            If Tmp_EmpAdditionWaitRow.AddSeq.Updated Then db.AddInParameter(dbcmd, "@AddSeq", DbType.Int32, Tmp_EmpAdditionWaitRow.AddSeq.Value)
            If Tmp_EmpAdditionWaitRow.AddCompID.Updated Then db.AddInParameter(dbcmd, "@AddCompID", DbType.String, Tmp_EmpAdditionWaitRow.AddCompID.Value)
            If Tmp_EmpAdditionWaitRow.AddDeptID.Updated Then db.AddInParameter(dbcmd, "@AddDeptID", DbType.String, Tmp_EmpAdditionWaitRow.AddDeptID.Value)
            If Tmp_EmpAdditionWaitRow.AddOrganID.Updated Then db.AddInParameter(dbcmd, "@AddOrganID", DbType.String, Tmp_EmpAdditionWaitRow.AddOrganID.Value)
            If Tmp_EmpAdditionWaitRow.AddFlowOrganID.Updated Then db.AddInParameter(dbcmd, "@AddFlowOrganID", DbType.String, Tmp_EmpAdditionWaitRow.AddFlowOrganID.Value)
            If Tmp_EmpAdditionWaitRow.Reason.Updated Then db.AddInParameter(dbcmd, "@Reason", DbType.String, Tmp_EmpAdditionWaitRow.Reason.Value)
            If Tmp_EmpAdditionWaitRow.FileNo.Updated Then db.AddInParameter(dbcmd, "@FileNo", DbType.String, Tmp_EmpAdditionWaitRow.FileNo.Value)
            If Tmp_EmpAdditionWaitRow.Remark.Updated Then db.AddInParameter(dbcmd, "@Remark", DbType.String, Tmp_EmpAdditionWaitRow.Remark.Value)
            If Tmp_EmpAdditionWaitRow.IsBoss.Updated Then db.AddInParameter(dbcmd, "@IsBoss", DbType.String, Tmp_EmpAdditionWaitRow.IsBoss.Value)
            If Tmp_EmpAdditionWaitRow.IsSecBoss.Updated Then db.AddInParameter(dbcmd, "@IsSecBoss", DbType.String, Tmp_EmpAdditionWaitRow.IsSecBoss.Value)
            If Tmp_EmpAdditionWaitRow.IsGroupBoss.Updated Then db.AddInParameter(dbcmd, "@IsGroupBoss", DbType.String, Tmp_EmpAdditionWaitRow.IsGroupBoss.Value)
            If Tmp_EmpAdditionWaitRow.IsSecGroupBoss.Updated Then db.AddInParameter(dbcmd, "@IsSecGroupBoss", DbType.String, Tmp_EmpAdditionWaitRow.IsSecGroupBoss.Value)
            If Tmp_EmpAdditionWaitRow.BossType.Updated Then db.AddInParameter(dbcmd, "@BossType", DbType.String, Tmp_EmpAdditionWaitRow.BossType.Value)
            If Tmp_EmpAdditionWaitRow.ValidMark.Updated Then db.AddInParameter(dbcmd, "@ValidMark", DbType.String, Tmp_EmpAdditionWaitRow.ValidMark.Value)
            If Tmp_EmpAdditionWaitRow.ExistsEmpAddition.Updated Then db.AddInParameter(dbcmd, "@ExistsEmpAddition", DbType.String, Tmp_EmpAdditionWaitRow.ExistsEmpAddition.Value)
            If Tmp_EmpAdditionWaitRow.CreateDate.Updated Then db.AddInParameter(dbcmd, "@CreateDate", DbType.Date, IIf(IsDateTimeNull(Tmp_EmpAdditionWaitRow.CreateDate.Value), Convert.ToDateTime("1900/1/1"), Tmp_EmpAdditionWaitRow.CreateDate.Value))
            If Tmp_EmpAdditionWaitRow.CreateComp.Updated Then db.AddInParameter(dbcmd, "@CreateComp", DbType.String, Tmp_EmpAdditionWaitRow.CreateComp.Value)
            If Tmp_EmpAdditionWaitRow.CreateID.Updated Then db.AddInParameter(dbcmd, "@CreateID", DbType.String, Tmp_EmpAdditionWaitRow.CreateID.Value)
            If Tmp_EmpAdditionWaitRow.LastChgDate.Updated Then db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(Tmp_EmpAdditionWaitRow.LastChgDate.Value), Convert.ToDateTime("1900/1/1"), Tmp_EmpAdditionWaitRow.LastChgDate.Value))
            If Tmp_EmpAdditionWaitRow.LastChgComp.Updated Then db.AddInParameter(dbcmd, "@LastChgComp", DbType.String, Tmp_EmpAdditionWaitRow.LastChgComp.Value)
            If Tmp_EmpAdditionWaitRow.LastChgID.Updated Then db.AddInParameter(dbcmd, "@LastChgID", DbType.String, Tmp_EmpAdditionWaitRow.LastChgID.Value)
            db.AddInParameter(dbcmd, "@PKCompID", DbType.String, IIf(Tmp_EmpAdditionWaitRow.LoadFromDataRow, Tmp_EmpAdditionWaitRow.CompID.OldValue, Tmp_EmpAdditionWaitRow.CompID.Value))
            db.AddInParameter(dbcmd, "@PKEmpID", DbType.String, IIf(Tmp_EmpAdditionWaitRow.LoadFromDataRow, Tmp_EmpAdditionWaitRow.EmpID.OldValue, Tmp_EmpAdditionWaitRow.EmpID.Value))
            db.AddInParameter(dbcmd, "@PKValidDate", DbType.Date, IIf(Tmp_EmpAdditionWaitRow.LoadFromDataRow, Tmp_EmpAdditionWaitRow.ValidDate.OldValue, Tmp_EmpAdditionWaitRow.ValidDate.Value))
            db.AddInParameter(dbcmd, "@PKSeq", DbType.Int32, IIf(Tmp_EmpAdditionWaitRow.LoadFromDataRow, Tmp_EmpAdditionWaitRow.Seq.OldValue, Tmp_EmpAdditionWaitRow.Seq.Value))
            db.AddInParameter(dbcmd, "@PKAddSeq", DbType.Int32, IIf(Tmp_EmpAdditionWaitRow.LoadFromDataRow, Tmp_EmpAdditionWaitRow.AddSeq.OldValue, Tmp_EmpAdditionWaitRow.AddSeq.Value))

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Update(ByVal Tmp_EmpAdditionWaitRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim strDot As String = String.Empty
        ...
        Public Function IsDataExists(ByVal Tmp_EmpAdditionWaitRow As Row) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0

            strSQL.AppendLine("Select Count(*) Cnt From Tmp_EmpAdditionWait")
            strSQL.AppendLine("Where CompID = @CompID")
            strSQL.AppendLine("And EmpID = @EmpID")
            strSQL.AppendLine("And ValidDate = @ValidDate")
            strSQL.AppendLine("And Seq = @Seq")
        ...
        Public Function IsDataExists(ByVal Tmp_EmpAdditionWaitRow As Row, ByVal tran As DbTransaction) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0
        ...
        Public Function Insert(ByVal Tmp_EmpAdditionWaitRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Insert into Tmp_EmpAdditionWait")
            strSQL.AppendLine("(")
            ...
            db.AddInParameter(dbcmd, "@CompID", DbType.String, Tmp_EmpAdditionWaitRow.CompID.Value)
            db.AddInParameter(dbcmd, "@EmpID", DbType.String, Tmp_EmpAdditionWaitRow.EmpID.Value)
            db.AddInParameter(dbcmd, "@ValidDate", DbType.Date, IIf(IsDateTimeNull(Tmp_EmpAdditionWaitRow.ValidDate.Value), Convert.ToDateTime("1900/1/1"), Tmp_EmpAdditionWaitRow.ValidDate.Value))
            db.AddInParameter(dbcmd, "@Seq", DbType.Int32, Tmp_EmpAdditionWaitRow.Seq.Value)
            db.AddInParameter(dbcmd, "@AddSeq", DbType.Int32, Tmp_EmpAdditionWaitRow.AddSeq.Value)
            db.AddInParameter(dbcmd, "@AddCompID", DbType.String, Tmp_EmpAdditionWaitRow.AddCompID.Value)
            db.AddInParameter(dbcmd, "@AddDeptID", DbType.String, Tmp_EmpAdditionWaitRow.AddDeptID.Value)
            db.AddInParameter(dbcmd, "@AddOrganID", DbType.String, Tmp_EmpAdditionWaitRow.AddOrganID.Value)
            db.AddInParameter(dbcmd, "@AddFlowOrganID", DbType.String, Tmp_EmpAdditionWaitRow.AddFlowOrganID.Value)
            db.AddInParameter(dbcmd, "@Reason", DbType.String, Tmp_EmpAdditionWaitRow.Reason.Value)
            db.AddInParameter(dbcmd, "@FileNo", DbType.String, Tmp_EmpAdditionWaitRow.FileNo.Value)
            db.AddInParameter(dbcmd, "@Remark", DbType.String, Tmp_EmpAdditionWaitRow.Remark.Value)
            db.AddInParameter(dbcmd, "@IsBoss", DbType.String, Tmp_EmpAdditionWaitRow.IsBoss.Value)
            db.AddInParameter(dbcmd, "@IsSecBoss", DbType.String, Tmp_EmpAdditionWaitRow.IsSecBoss.Value)
            db.AddInParameter(dbcmd, "@IsGroupBoss", DbType.String, Tmp_EmpAdditionWaitRow.IsGroupBoss.Value)
            db.AddInParameter(dbcmd, "@IsSecGroupBoss", DbType.String, Tmp_EmpAdditionWaitRow.IsSecGroupBoss.Value)
            db.AddInParameter(dbcmd, "@BossType", DbType.String, Tmp_EmpAdditionWaitRow.BossType.Value)
            db.AddInParameter(dbcmd, "@ValidMark", DbType.String, Tmp_EmpAdditionWaitRow.ValidMark.Value)
            db.AddInParameter(dbcmd, "@ExistsEmpAddition", DbType.String, Tmp_EmpAdditionWaitRow.ExistsEmpAddition.Value)
            db.AddInParameter(dbcmd, "@CreateDate", DbType.Date, IIf(IsDateTimeNull(Tmp_EmpAdditionWaitRow.CreateDate.Value), Convert.ToDateTime("1900/1/1"), Tmp_EmpAdditionWaitRow.CreateDate.Value))
            db.AddInParameter(dbcmd, "@CreateComp", DbType.String, Tmp_EmpAdditionWaitRow.CreateComp.Value)
            db.AddInParameter(dbcmd, "@CreateID", DbType.String, Tmp_EmpAdditionWaitRow.CreateID.Value)
            db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(Tmp_EmpAdditionWaitRow.LastChgDate.Value), Convert.ToDateTime("1900/1/1"), Tmp_EmpAdditionWaitRow.LastChgDate.Value))
            db.AddInParameter(dbcmd, "@LastChgComp", DbType.String, Tmp_EmpAdditionWaitRow.LastChgComp.Value)
            db.AddInParameter(dbcmd, "@LastChgID", DbType.String, Tmp_EmpAdditionWaitRow.LastChgID.Value)

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Insert(ByVal Tmp_EmpAdditionWaitRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
