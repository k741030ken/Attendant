...
Namespace beCheckInFile_SPHBK1
    Public Class Table
        ...
        Private m_Fields As String() = { "CompID", "EmpID", "Remark", "File1", "File2", "File3", "File4", "File5", "File6", "File7" _
                                    ...
                                    , "File19", "LastChgComp", "LastChgID", "LastChgDate" }
        ...
        Public ReadOnly Property Rows() As beCheckInFile_SPHBK1.Rows 
            Get
                Return m_Rows
            End Get
        End Property
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub Transfer2Row(CheckInFile_SPHBK1Table As DataTable)
            For Each dr As DataRow In CheckInFile_SPHBK1Table.Rows
        ...
        Public Function Transfer2DataTable() As DataTable
            ...
            For i As Integer = 0 To m_Rows.Count - 1
                ...
                dr(m_Rows(i).File19.FieldName) = m_Rows(i).File19.Value
    ...
    Public Class Rows
        ...
        Public Sub Add(CheckInFile_SPHBK1Row As Row)
            m_Rows.Add(CheckInFile_SPHBK1Row)
        End Sub

        Public Sub Remove(CheckInFile_SPHBK1Row As Row)
            If m_Rows.IndexOf(CheckInFile_SPHBK1Row) >= 0 Then
                m_Rows.Remove(CheckInFile_SPHBK1Row)
            End If
        End Sub
    ...
    Public Class Row
        ...
        Private FI_File19 As Field(Of String) = new Field(Of String)("File19", true)
        ...
        Public Function CreateUpdateSQL(ByVal fieldName As String) As Boolean
            Select Case fieldName
                ...
                Case "File19"
                    return FI_File19.CreateUpdateSQL
                Case "LastChgComp"
        ...
        Public Sub New(ByVal dr As System.Data.DataRow)
            ...
            FI_File19.SetInitValue(dr("File19"))
        ...
        Public ReadOnly Property File19 As Field(Of String) 
            Get
                Return FI_File19
            End Get
        End Property
    ...
    Public Class Service
        Public Function DeleteRowByPrimaryKey(ByVal CheckInFile_SPHBK1Row As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Delete From CheckInFile_SPHBK1")
            strSQL.AppendLine("Where CompID = @CompID")
            strSQL.AppendLine("And EmpID = @EmpID")

            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            db.AddInParameter(dbcmd, "@CompID", DbType.String, CheckInFile_SPHBK1Row.CompID.Value)
            db.AddInParameter(dbcmd, "@EmpID", DbType.String, CheckInFile_SPHBK1Row.EmpID.Value)

            return db.ExecuteNonQuery(dbcmd)
        End Function

        public Function DeleteRowByPrimaryKey(ByVal CheckInFile_SPHBK1Row As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function DeleteRowByPrimaryKey(ByVal CheckInFile_SPHBK1Row As Row()) As Integer
            ...
            using cn As DbConnection = db.CreateConnection()
                ...
                Try
                    For Each r As Row In CheckInFile_SPHBK1Row
        ...
        Public Function QueryByKey(ByVal CheckInFile_SPHBK1Row As Row) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Select * From CheckInFile_SPHBK1")
            strSQL.AppendLine("Where CompID = @CompID")
            strSQL.AppendLine("And EmpID = @EmpID")
        ...
        Public Function QueryByKey(CheckInFile_SPHBK1Row As Row, tran As DbTransaction) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function Update(ByVal CheckInFile_SPHBK1Row As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim strDot As String = String.Empty

            strSQL.AppendLine("Update CheckInFile_SPHBK1 Set")
            For i As Integer = 0 To CheckInFile_SPHBK1Row.FieldNames.Length - 1
                If Not CheckInFile_SPHBK1Row.IsIdentityField(CheckInFile_SPHBK1Row.FieldNames(i)) AndAlso CheckInFile_SPHBK1Row.IsUpdated(CheckInFile_SPHBK1Row.FieldNames(i)) AndAlso CheckInFile_SPHBK1Row.CreateUpdateSQL(CheckInFile_SPHBK1Row.FieldNames(i)) Then
                    strSQL.AppendLine(string.Format("{0}{1} = @{1}", strDot, CheckInFile_SPHBK1Row.FieldNames(i)))
                    strDot = ","
                End If
            Next
            ...
            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            If CheckInFile_SPHBK1Row.CompID.Updated Then db.AddInParameter(dbcmd, "@CompID", DbType.String, CheckInFile_SPHBK1Row.CompID.Value)
            If CheckInFile_SPHBK1Row.EmpID.Updated Then db.AddInParameter(dbcmd, "@EmpID", DbType.String, CheckInFile_SPHBK1Row.EmpID.Value)
            If CheckInFile_SPHBK1Row.Remark.Updated Then db.AddInParameter(dbcmd, "@Remark", DbType.String, CheckInFile_SPHBK1Row.Remark.Value)
            If CheckInFile_SPHBK1Row.File1.Updated Then db.AddInParameter(dbcmd, "@File1", DbType.String, CheckInFile_SPHBK1Row.File1.Value)
            If CheckInFile_SPHBK1Row.File2.Updated Then db.AddInParameter(dbcmd, "@File2", DbType.String, CheckInFile_SPHBK1Row.File2.Value)
            If CheckInFile_SPHBK1Row.File3.Updated Then db.AddInParameter(dbcmd, "@File3", DbType.String, CheckInFile_SPHBK1Row.File3.Value)
            If CheckInFile_SPHBK1Row.File4.Updated Then db.AddInParameter(dbcmd, "@File4", DbType.String, CheckInFile_SPHBK1Row.File4.Value)
            If CheckInFile_SPHBK1Row.File5.Updated Then db.AddInParameter(dbcmd, "@File5", DbType.String, CheckInFile_SPHBK1Row.File5.Value)
            If CheckInFile_SPHBK1Row.File6.Updated Then db.AddInParameter(dbcmd, "@File6", DbType.String, CheckInFile_SPHBK1Row.File6.Value)
            If CheckInFile_SPHBK1Row.File7.Updated Then db.AddInParameter(dbcmd, "@File7", DbType.String, CheckInFile_SPHBK1Row.File7.Value)
            If CheckInFile_SPHBK1Row.File8.Updated Then db.AddInParameter(dbcmd, "@File8", DbType.String, CheckInFile_SPHBK1Row.File8.Value)
            If CheckInFile_SPHBK1Row.File9.Updated Then db.AddInParameter(dbcmd, "@File9", DbType.String, CheckInFile_SPHBK1Row.File9.Value)
            If CheckInFile_SPHBK1Row.File10.Updated Then db.AddInParameter(dbcmd, "@File10", DbType.String, CheckInFile_SPHBK1Row.File10.Value)
            If CheckInFile_SPHBK1Row.File11.Updated Then db.AddInParameter(dbcmd, "@File11", DbType.String, CheckInFile_SPHBK1Row.File11.Value)
            If CheckInFile_SPHBK1Row.File12.Updated Then db.AddInParameter(dbcmd, "@File12", DbType.String, CheckInFile_SPHBK1Row.File12.Value)
            If CheckInFile_SPHBK1Row.File13.Updated Then db.AddInParameter(dbcmd, "@File13", DbType.String, CheckInFile_SPHBK1Row.File13.Value)
            If CheckInFile_SPHBK1Row.File14.Updated Then db.AddInParameter(dbcmd, "@File14", DbType.String, CheckInFile_SPHBK1Row.File14.Value)
            If CheckInFile_SPHBK1Row.File15.Updated Then db.AddInParameter(dbcmd, "@File15", DbType.String, CheckInFile_SPHBK1Row.File15.Value)
            If CheckInFile_SPHBK1Row.File16.Updated Then db.AddInParameter(dbcmd, "@File16", DbType.String, CheckInFile_SPHBK1Row.File16.Value)
            If CheckInFile_SPHBK1Row.File17.Updated Then db.AddInParameter(dbcmd, "@File17", DbType.String, CheckInFile_SPHBK1Row.File17.Value)
            If CheckInFile_SPHBK1Row.File18.Updated Then db.AddInParameter(dbcmd, "@File18", DbType.String, CheckInFile_SPHBK1Row.File18.Value)
            If CheckInFile_SPHBK1Row.File19.Updated Then db.AddInParameter(dbcmd, "@File19", DbType.String, CheckInFile_SPHBK1Row.File19.Value)
            If CheckInFile_SPHBK1Row.LastChgComp.Updated Then db.AddInParameter(dbcmd, "@LastChgComp", DbType.String, CheckInFile_SPHBK1Row.LastChgComp.Value)
            If CheckInFile_SPHBK1Row.LastChgID.Updated Then db.AddInParameter(dbcmd, "@LastChgID", DbType.String, CheckInFile_SPHBK1Row.LastChgID.Value)
            If CheckInFile_SPHBK1Row.LastChgDate.Updated Then db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(CheckInFile_SPHBK1Row.LastChgDate.Value), Convert.ToDateTime("1900/1/1"), CheckInFile_SPHBK1Row.LastChgDate.Value))
            db.AddInParameter(dbcmd, "@PKCompID", DbType.String, IIf(CheckInFile_SPHBK1Row.LoadFromDataRow, CheckInFile_SPHBK1Row.CompID.OldValue, CheckInFile_SPHBK1Row.CompID.Value))
            db.AddInParameter(dbcmd, "@PKEmpID", DbType.String, IIf(CheckInFile_SPHBK1Row.LoadFromDataRow, CheckInFile_SPHBK1Row.EmpID.OldValue, CheckInFile_SPHBK1Row.EmpID.Value))

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Update(ByVal CheckInFile_SPHBK1Row As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim strDot As String = String.Empty
            ...
            Using cn As DbConnection = db.CreateConnection()
                ...
                Try
                    For Each r As Row In CheckInFile_SPHBK1Row
                        ...
                        If r.File19.Updated Then db.AddInParameter(dbcmd, "@File19", DbType.String, r.File19.Value)
        ...
        Public Function IsDataExists(ByVal CheckInFile_SPHBK1Row As Row) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0

            strSQL.AppendLine("Select Count(*) Cnt From CheckInFile_SPHBK1")
            strSQL.AppendLine("Where CompID = @CompID")
            strSQL.AppendLine("And EmpID = @EmpID")
        ...
        Public Function IsDataExists(ByVal CheckInFile_SPHBK1Row As Row, ByVal tran As DbTransaction) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0
        ...
        Public Function Insert(ByVal CheckInFile_SPHBK1Row As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Insert into CheckInFile_SPHBK1")
            strSQL.AppendLine("(")
            strSQL.AppendLine("    CompID, EmpID, Remark, File1, File2, File3, File4, File5, File6, File7, File8, File9,")
            strSQL.AppendLine("    File10, File11, File12, File13, File14, File15, File16, File17, File18, File19, LastChgComp,")
            ...
            db.AddInParameter(dbcmd, "@CompID", DbType.String, CheckInFile_SPHBK1Row.CompID.Value)
            db.AddInParameter(dbcmd, "@EmpID", DbType.String, CheckInFile_SPHBK1Row.EmpID.Value)
            db.AddInParameter(dbcmd, "@Remark", DbType.String, CheckInFile_SPHBK1Row.Remark.Value)
            db.AddInParameter(dbcmd, "@File1", DbType.String, CheckInFile_SPHBK1Row.File1.Value)
            db.AddInParameter(dbcmd, "@File2", DbType.String, CheckInFile_SPHBK1Row.File2.Value)
            db.AddInParameter(dbcmd, "@File3", DbType.String, CheckInFile_SPHBK1Row.File3.Value)
            db.AddInParameter(dbcmd, "@File4", DbType.String, CheckInFile_SPHBK1Row.File4.Value)
            db.AddInParameter(dbcmd, "@File5", DbType.String, CheckInFile_SPHBK1Row.File5.Value)
            db.AddInParameter(dbcmd, "@File6", DbType.String, CheckInFile_SPHBK1Row.File6.Value)
            db.AddInParameter(dbcmd, "@File7", DbType.String, CheckInFile_SPHBK1Row.File7.Value)
            db.AddInParameter(dbcmd, "@File8", DbType.String, CheckInFile_SPHBK1Row.File8.Value)
            db.AddInParameter(dbcmd, "@File9", DbType.String, CheckInFile_SPHBK1Row.File9.Value)
            db.AddInParameter(dbcmd, "@File10", DbType.String, CheckInFile_SPHBK1Row.File10.Value)
            db.AddInParameter(dbcmd, "@File11", DbType.String, CheckInFile_SPHBK1Row.File11.Value)
            db.AddInParameter(dbcmd, "@File12", DbType.String, CheckInFile_SPHBK1Row.File12.Value)
            db.AddInParameter(dbcmd, "@File13", DbType.String, CheckInFile_SPHBK1Row.File13.Value)
            db.AddInParameter(dbcmd, "@File14", DbType.String, CheckInFile_SPHBK1Row.File14.Value)
            db.AddInParameter(dbcmd, "@File15", DbType.String, CheckInFile_SPHBK1Row.File15.Value)
            db.AddInParameter(dbcmd, "@File16", DbType.String, CheckInFile_SPHBK1Row.File16.Value)
            db.AddInParameter(dbcmd, "@File17", DbType.String, CheckInFile_SPHBK1Row.File17.Value)
            db.AddInParameter(dbcmd, "@File18", DbType.String, CheckInFile_SPHBK1Row.File18.Value)
            db.AddInParameter(dbcmd, "@File19", DbType.String, CheckInFile_SPHBK1Row.File19.Value)
            db.AddInParameter(dbcmd, "@LastChgComp", DbType.String, CheckInFile_SPHBK1Row.LastChgComp.Value)
            db.AddInParameter(dbcmd, "@LastChgID", DbType.String, CheckInFile_SPHBK1Row.LastChgID.Value)
            db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(CheckInFile_SPHBK1Row.LastChgDate.Value), Convert.ToDateTime("1900/1/1"), CheckInFile_SPHBK1Row.LastChgDate.Value))

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Insert(ByVal CheckInFile_SPHBK1Row As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase("eHRMSDB")
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            ...
            Using cn As DbConnection = db.CreateConnection()
                ...
                Try
                    For Each r As Row In CheckInFile_SPHBK1Row
                        ...
                        db.AddInParameter(dbcmd, "@File19", DbType.String, r.File19.Value)
