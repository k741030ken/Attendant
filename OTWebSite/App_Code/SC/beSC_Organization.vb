...
Namespace beSC_Organization
    Public Class Table
        ...
        Private m_Fields As String() = { "CompID", "OrganID", "OrganName", "OrganEngName", "VirtualFlag", "UpOrganID", "DeptID", "GroupType", "GroupID", "Boss" _
                                    , "BossCompID", "BossType", "BossTemporary", "SecBoss", "SecBossCompID", "PersonPart", "CheckPart", "WorkSiteID", "WorkTypeID", "CostDeptID", "CostType" _
                                    , "AccountBranch", "InValidFlag", "Depth", "BranchFlag", "RoleCode", "InvoiceNo", "SortOrder", "OrgType", "ValidDateB", "ValidDateE", "Remark" _
        ...
        Private m_Types As System.Type() = { GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String) _
                                    ...
                                    , GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(Date), GetType(Date), GetType(String) _
                                    , GetType(String), GetType(String), GetType(Date) }
        Private m_PrimaryFields As String() = { "CompID", "OrganID" }

        Public ReadOnly Property Rows() As beSC_Organization.Rows 
            Get
                Return m_Rows
            End Get
        End Property
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub Transfer2Row(SC_OrganizationTable As DataTable)
            For Each dr As DataRow In SC_OrganizationTable.Rows
    ...
    Public Class Rows
        ...
        Public Sub Add(SC_OrganizationRow As Row)
            m_Rows.Add(SC_OrganizationRow)
        End Sub

        Public Sub Remove(SC_OrganizationRow As Row)
            If m_Rows.IndexOf(SC_OrganizationRow) >= 0 Then
                m_Rows.Remove(SC_OrganizationRow)
            End If
        End Sub
    ...
    Public Class Row
        ...
        Public Sub New()
            ...
            FI_ValidDateB.SetInitValue(DateTime.Now)
            FI_ValidDateE.SetInitValue(DateTime.Now)
    ...
    Public Class Service
        Public Function DeleteRowByPrimaryKey(ByVal SC_OrganizationRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Delete From SC_Organization")
            strSQL.AppendLine("Where CompID = @CompID")
            strSQL.AppendLine("And OrganID = @OrganID")

            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            db.AddInParameter(dbcmd, "@CompID", DbType.String, SC_OrganizationRow.CompID.Value)
            db.AddInParameter(dbcmd, "@OrganID", DbType.String, SC_OrganizationRow.OrganID.Value)

            return db.ExecuteNonQuery(dbcmd)
        End Function

        public Function DeleteRowByPrimaryKey(ByVal SC_OrganizationRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function DeleteRowByPrimaryKey(ByVal SC_OrganizationRow As Row()) As Integer
            ...
            using cn As DbConnection = db.CreateConnection()
                ...
                Try
                    For Each r As Row In SC_OrganizationRow
        ...
        Public Function QueryByKey(ByVal SC_OrganizationRow As Row) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Select * From SC_Organization")
            strSQL.AppendLine("Where CompID = @CompID")
            strSQL.AppendLine("And OrganID = @OrganID")
        ...
        Public Function QueryByKey(SC_OrganizationRow As Row, tran As DbTransaction) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function Update(ByVal SC_OrganizationRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim strDot As String = String.Empty

            strSQL.AppendLine("Update SC_Organization Set")
            For i As Integer = 0 To SC_OrganizationRow.FieldNames.Length - 1
                If Not SC_OrganizationRow.IsIdentityField(SC_OrganizationRow.FieldNames(i)) AndAlso SC_OrganizationRow.IsUpdated(SC_OrganizationRow.FieldNames(i)) AndAlso SC_OrganizationRow.CreateUpdateSQL(SC_OrganizationRow.FieldNames(i)) Then
                    strSQL.AppendLine(string.Format("{0}{1} = @{1}", strDot, SC_OrganizationRow.FieldNames(i)))
                    strDot = ","
                End If
            Next
            ...
            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            If SC_OrganizationRow.CompID.Updated Then db.AddInParameter(dbcmd, "@CompID", DbType.String, SC_OrganizationRow.CompID.Value)
            If SC_OrganizationRow.OrganID.Updated Then db.AddInParameter(dbcmd, "@OrganID", DbType.String, SC_OrganizationRow.OrganID.Value)
            If SC_OrganizationRow.OrganName.Updated Then db.AddInParameter(dbcmd, "@OrganName", DbType.String, SC_OrganizationRow.OrganName.Value)
            If SC_OrganizationRow.OrganEngName.Updated Then db.AddInParameter(dbcmd, "@OrganEngName", DbType.String, SC_OrganizationRow.OrganEngName.Value)
            If SC_OrganizationRow.VirtualFlag.Updated Then db.AddInParameter(dbcmd, "@VirtualFlag", DbType.String, SC_OrganizationRow.VirtualFlag.Value)
            If SC_OrganizationRow.UpOrganID.Updated Then db.AddInParameter(dbcmd, "@UpOrganID", DbType.String, SC_OrganizationRow.UpOrganID.Value)
            If SC_OrganizationRow.DeptID.Updated Then db.AddInParameter(dbcmd, "@DeptID", DbType.String, SC_OrganizationRow.DeptID.Value)
            If SC_OrganizationRow.GroupType.Updated Then db.AddInParameter(dbcmd, "@GroupType", DbType.String, SC_OrganizationRow.GroupType.Value)
            If SC_OrganizationRow.GroupID.Updated Then db.AddInParameter(dbcmd, "@GroupID", DbType.String, SC_OrganizationRow.GroupID.Value)
            If SC_OrganizationRow.Boss.Updated Then db.AddInParameter(dbcmd, "@Boss", DbType.String, SC_OrganizationRow.Boss.Value)
            If SC_OrganizationRow.BossCompID.Updated Then db.AddInParameter(dbcmd, "@BossCompID", DbType.String, SC_OrganizationRow.BossCompID.Value)
            If SC_OrganizationRow.BossType.Updated Then db.AddInParameter(dbcmd, "@BossType", DbType.String, SC_OrganizationRow.BossType.Value)
            If SC_OrganizationRow.BossTemporary.Updated Then db.AddInParameter(dbcmd, "@BossTemporary", DbType.String, SC_OrganizationRow.BossTemporary.Value)
            If SC_OrganizationRow.SecBoss.Updated Then db.AddInParameter(dbcmd, "@SecBoss", DbType.String, SC_OrganizationRow.SecBoss.Value)
            If SC_OrganizationRow.SecBossCompID.Updated Then db.AddInParameter(dbcmd, "@SecBossCompID", DbType.String, SC_OrganizationRow.SecBossCompID.Value)
            If SC_OrganizationRow.PersonPart.Updated Then db.AddInParameter(dbcmd, "@PersonPart", DbType.String, SC_OrganizationRow.PersonPart.Value)
            If SC_OrganizationRow.CheckPart.Updated Then db.AddInParameter(dbcmd, "@CheckPart", DbType.String, SC_OrganizationRow.CheckPart.Value)
            If SC_OrganizationRow.WorkSiteID.Updated Then db.AddInParameter(dbcmd, "@WorkSiteID", DbType.String, SC_OrganizationRow.WorkSiteID.Value)
            If SC_OrganizationRow.WorkTypeID.Updated Then db.AddInParameter(dbcmd, "@WorkTypeID", DbType.String, SC_OrganizationRow.WorkTypeID.Value)
            If SC_OrganizationRow.CostDeptID.Updated Then db.AddInParameter(dbcmd, "@CostDeptID", DbType.String, SC_OrganizationRow.CostDeptID.Value)
            If SC_OrganizationRow.CostType.Updated Then db.AddInParameter(dbcmd, "@CostType", DbType.String, SC_OrganizationRow.CostType.Value)
            If SC_OrganizationRow.AccountBranch.Updated Then db.AddInParameter(dbcmd, "@AccountBranch", DbType.String, SC_OrganizationRow.AccountBranch.Value)
            If SC_OrganizationRow.InValidFlag.Updated Then db.AddInParameter(dbcmd, "@InValidFlag", DbType.String, SC_OrganizationRow.InValidFlag.Value)
            If SC_OrganizationRow.Depth.Updated Then db.AddInParameter(dbcmd, "@Depth", DbType.String, SC_OrganizationRow.Depth.Value)
            If SC_OrganizationRow.BranchFlag.Updated Then db.AddInParameter(dbcmd, "@BranchFlag", DbType.String, SC_OrganizationRow.BranchFlag.Value)
            If SC_OrganizationRow.RoleCode.Updated Then db.AddInParameter(dbcmd, "@RoleCode", DbType.String, SC_OrganizationRow.RoleCode.Value)
            If SC_OrganizationRow.InvoiceNo.Updated Then db.AddInParameter(dbcmd, "@InvoiceNo", DbType.String, SC_OrganizationRow.InvoiceNo.Value)
            If SC_OrganizationRow.SortOrder.Updated Then db.AddInParameter(dbcmd, "@SortOrder", DbType.String, SC_OrganizationRow.SortOrder.Value)
            If SC_OrganizationRow.OrgType.Updated Then db.AddInParameter(dbcmd, "@OrgType", DbType.String, SC_OrganizationRow.OrgType.Value)
            If SC_OrganizationRow.ValidDateB.Updated Then db.AddInParameter(dbcmd, "@ValidDateB", DbType.Date, IIf(IsDateTimeNull(SC_OrganizationRow.ValidDateB.Value), Convert.ToDateTime("1900/1/1"), SC_OrganizationRow.ValidDateB.Value))
            If SC_OrganizationRow.ValidDateE.Updated Then db.AddInParameter(dbcmd, "@ValidDateE", DbType.Date, IIf(IsDateTimeNull(SC_OrganizationRow.ValidDateE.Value), Convert.ToDateTime("1900/1/1"), SC_OrganizationRow.ValidDateE.Value))
            If SC_OrganizationRow.Remark.Updated Then db.AddInParameter(dbcmd, "@Remark", DbType.String, SC_OrganizationRow.Remark.Value)
            If SC_OrganizationRow.LastChgComp.Updated Then db.AddInParameter(dbcmd, "@LastChgComp", DbType.String, SC_OrganizationRow.LastChgComp.Value)
            If SC_OrganizationRow.LastChgID.Updated Then db.AddInParameter(dbcmd, "@LastChgID", DbType.String, SC_OrganizationRow.LastChgID.Value)
            If SC_OrganizationRow.LastChgDate.Updated Then db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(SC_OrganizationRow.LastChgDate.Value), Convert.ToDateTime("1900/1/1"), SC_OrganizationRow.LastChgDate.Value))
            db.AddInParameter(dbcmd, "@PKCompID", DbType.String, IIf(SC_OrganizationRow.LoadFromDataRow, SC_OrganizationRow.CompID.OldValue, SC_OrganizationRow.CompID.Value))
            db.AddInParameter(dbcmd, "@PKOrganID", DbType.String, IIf(SC_OrganizationRow.LoadFromDataRow, SC_OrganizationRow.OrganID.OldValue, SC_OrganizationRow.OrganID.Value))

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Update(ByVal SC_OrganizationRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim strDot As String = String.Empty
        ...
        Public Function IsDataExists(ByVal SC_OrganizationRow As Row) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0

            strSQL.AppendLine("Select Count(*) Cnt From SC_Organization")
            strSQL.AppendLine("Where CompID = @CompID")
            strSQL.AppendLine("And OrganID = @OrganID")
        ...
        Public Function IsDataExists(ByVal SC_OrganizationRow As Row, ByVal tran As DbTransaction) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0
        ...
        Public Function Insert(ByVal SC_OrganizationRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Insert into SC_Organization")
            strSQL.AppendLine("(")
            ...
            strSQL.AppendLine("    CheckPart, WorkSiteID, WorkTypeID, CostDeptID, CostType, AccountBranch, InValidFlag,")
            strSQL.AppendLine("    Depth, BranchFlag, RoleCode, InvoiceNo, SortOrder, OrgType, ValidDateB, ValidDateE,")
            strSQL.AppendLine("    Remark, LastChgComp, LastChgID, LastChgDate")
            strSQL.AppendLine(")")
            ...
            db.AddInParameter(dbcmd, "@CompID", DbType.String, SC_OrganizationRow.CompID.Value)
            db.AddInParameter(dbcmd, "@OrganID", DbType.String, SC_OrganizationRow.OrganID.Value)
            db.AddInParameter(dbcmd, "@OrganName", DbType.String, SC_OrganizationRow.OrganName.Value)
            db.AddInParameter(dbcmd, "@OrganEngName", DbType.String, SC_OrganizationRow.OrganEngName.Value)
            db.AddInParameter(dbcmd, "@VirtualFlag", DbType.String, SC_OrganizationRow.VirtualFlag.Value)
            db.AddInParameter(dbcmd, "@UpOrganID", DbType.String, SC_OrganizationRow.UpOrganID.Value)
            db.AddInParameter(dbcmd, "@DeptID", DbType.String, SC_OrganizationRow.DeptID.Value)
            db.AddInParameter(dbcmd, "@GroupType", DbType.String, SC_OrganizationRow.GroupType.Value)
            db.AddInParameter(dbcmd, "@GroupID", DbType.String, SC_OrganizationRow.GroupID.Value)
            db.AddInParameter(dbcmd, "@Boss", DbType.String, SC_OrganizationRow.Boss.Value)
            db.AddInParameter(dbcmd, "@BossCompID", DbType.String, SC_OrganizationRow.BossCompID.Value)
            db.AddInParameter(dbcmd, "@BossType", DbType.String, SC_OrganizationRow.BossType.Value)
            db.AddInParameter(dbcmd, "@BossTemporary", DbType.String, SC_OrganizationRow.BossTemporary.Value)
            db.AddInParameter(dbcmd, "@SecBoss", DbType.String, SC_OrganizationRow.SecBoss.Value)
            db.AddInParameter(dbcmd, "@SecBossCompID", DbType.String, SC_OrganizationRow.SecBossCompID.Value)
            db.AddInParameter(dbcmd, "@PersonPart", DbType.String, SC_OrganizationRow.PersonPart.Value)
            db.AddInParameter(dbcmd, "@CheckPart", DbType.String, SC_OrganizationRow.CheckPart.Value)
            db.AddInParameter(dbcmd, "@WorkSiteID", DbType.String, SC_OrganizationRow.WorkSiteID.Value)
            db.AddInParameter(dbcmd, "@WorkTypeID", DbType.String, SC_OrganizationRow.WorkTypeID.Value)
            db.AddInParameter(dbcmd, "@CostDeptID", DbType.String, SC_OrganizationRow.CostDeptID.Value)
            db.AddInParameter(dbcmd, "@CostType", DbType.String, SC_OrganizationRow.CostType.Value)
            db.AddInParameter(dbcmd, "@AccountBranch", DbType.String, SC_OrganizationRow.AccountBranch.Value)
            db.AddInParameter(dbcmd, "@InValidFlag", DbType.String, SC_OrganizationRow.InValidFlag.Value)
            db.AddInParameter(dbcmd, "@Depth", DbType.String, SC_OrganizationRow.Depth.Value)
            db.AddInParameter(dbcmd, "@BranchFlag", DbType.String, SC_OrganizationRow.BranchFlag.Value)
            db.AddInParameter(dbcmd, "@RoleCode", DbType.String, SC_OrganizationRow.RoleCode.Value)
            db.AddInParameter(dbcmd, "@InvoiceNo", DbType.String, SC_OrganizationRow.InvoiceNo.Value)
            db.AddInParameter(dbcmd, "@SortOrder", DbType.String, SC_OrganizationRow.SortOrder.Value)
            db.AddInParameter(dbcmd, "@OrgType", DbType.String, SC_OrganizationRow.OrgType.Value)
            db.AddInParameter(dbcmd, "@ValidDateB", DbType.Date, IIf(IsDateTimeNull(SC_OrganizationRow.ValidDateB.Value), Convert.ToDateTime("1900/1/1"), SC_OrganizationRow.ValidDateB.Value))
            db.AddInParameter(dbcmd, "@ValidDateE", DbType.Date, IIf(IsDateTimeNull(SC_OrganizationRow.ValidDateE.Value), Convert.ToDateTime("1900/1/1"), SC_OrganizationRow.ValidDateE.Value))
            db.AddInParameter(dbcmd, "@Remark", DbType.String, SC_OrganizationRow.Remark.Value)
            db.AddInParameter(dbcmd, "@LastChgComp", DbType.String, SC_OrganizationRow.LastChgComp.Value)
            db.AddInParameter(dbcmd, "@LastChgID", DbType.String, SC_OrganizationRow.LastChgID.Value)
            db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(SC_OrganizationRow.LastChgDate.Value), Convert.ToDateTime("1900/1/1"), SC_OrganizationRow.LastChgDate.Value))

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Insert(ByVal SC_OrganizationRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function Insert(ByVal SC_OrganizationRow As Row(), ByVal tran As DbTransaction) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intRowsAffected As Integer = 0
