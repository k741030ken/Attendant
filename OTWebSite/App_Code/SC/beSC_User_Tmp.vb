...
Namespace beSC_User_Tmp
    Public Class Table
        Private m_Rows As Rows = New Rows()
        Private m_Fields As String() = { "UserID", "UserName", "EngName", "WorkStatus", "BusinessFlag", "CompID", "CompName", "DeptID", "OrganID", "BusinessID" _
                                    , "WorkTypeID", "WorkType", "SecWorkTypeID", "SecWorkType", "RankID", "TitleName", "Password", "PasswordErrorCount", "ExpireDate", "EMail", "BanMark" _
                                    , "LastLoginDate", "HostName", "UpdateFlag", "CreateDate", "LastChgID", "LastChgDate" }
        Private m_Types As System.Type() = { GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String) _
                                    , GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(String), GetType(Integer), GetType(Date), GetType(String), GetType(String) _
                                    , GetType(Date), GetType(String), GetType(String), GetType(Date), GetType(String), GetType(Date) }
        Private m_PrimaryFields As String() = { "UserID" }

        Public ReadOnly Property Rows() As beSC_User_Tmp.Rows 
            Get
                Return m_Rows
            End Get
        End Property
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub Transfer2Row(SC_User_TmpTable As DataTable)
            For Each dr As DataRow In SC_User_TmpTable.Rows
    ...
    Public Class Rows
        ...
        Public Sub Add(SC_User_TmpRow As Row)
            m_Rows.Add(SC_User_TmpRow)
        End Sub

        Public Sub Remove(SC_User_TmpRow As Row)
            If m_Rows.IndexOf(SC_User_TmpRow) >= 0 Then
                m_Rows.Remove(SC_User_TmpRow)
            End If
        End Sub
    ...
    Public Class Row
        ...
        Private m_FieldNames As String() = { "UserID", "UserName", "EngName", "WorkStatus", "BusinessFlag", "CompID", "CompName", "DeptID", "OrganID", "BusinessID" _
                                    , "WorkTypeID", "WorkType", "SecWorkTypeID", "SecWorkType", "RankID", "TitleName", "Password", "PasswordErrorCount", "ExpireDate", "EMail", "BanMark" _
                                    , "LastLoginDate", "HostName", "UpdateFlag", "CreateDate", "LastChgID", "LastChgDate" }
        Private m_PrimaryFields As String() = { "UserID" }
    ...
    Public Class Service
        Public Function DeleteRowByPrimaryKey(ByVal SC_User_TmpRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Delete From SC_User_Tmp")
            strSQL.AppendLine("Where UserID = @UserID")

            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            db.AddInParameter(dbcmd, "@UserID", DbType.String, SC_User_TmpRow.UserID.Value)

            return db.ExecuteNonQuery(dbcmd)
        End Function

        public Function DeleteRowByPrimaryKey(ByVal SC_User_TmpRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function DeleteRowByPrimaryKey(ByVal SC_User_TmpRow As Row()) As Integer
            ...
            using cn As DbConnection = db.CreateConnection()
                ...
                Try
                    For Each r As Row In SC_User_TmpRow
        ...
        Public Function QueryByKey(ByVal SC_User_TmpRow As Row) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Select * From SC_User_Tmp")
            strSQL.AppendLine("Where UserID = @UserID")
        ...
        Public Function QueryByKey(SC_User_TmpRow As Row, tran As DbTransaction) As DataSet
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
        ...
        Public Function Update(ByVal SC_User_TmpRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim strDot As String = String.Empty

            strSQL.AppendLine("Update SC_User_Tmp Set")
            For i As Integer = 0 To SC_User_TmpRow.FieldNames.Length - 1
                If Not SC_User_TmpRow.IsIdentityField(SC_User_TmpRow.FieldNames(i)) AndAlso SC_User_TmpRow.IsUpdated(SC_User_TmpRow.FieldNames(i)) AndAlso SC_User_TmpRow.CreateUpdateSQL(SC_User_TmpRow.FieldNames(i)) Then
                    strSQL.AppendLine(string.Format("{0}{1} = @{1}", strDot, SC_User_TmpRow.FieldNames(i)))
                    strDot = ","
                End If
            Next
            ...
            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            If SC_User_TmpRow.UserID.Updated Then db.AddInParameter(dbcmd, "@UserID", DbType.String, SC_User_TmpRow.UserID.Value)
            If SC_User_TmpRow.UserName.Updated Then db.AddInParameter(dbcmd, "@UserName", DbType.String, SC_User_TmpRow.UserName.Value)
            If SC_User_TmpRow.EngName.Updated Then db.AddInParameter(dbcmd, "@EngName", DbType.String, SC_User_TmpRow.EngName.Value)
            If SC_User_TmpRow.WorkStatus.Updated Then db.AddInParameter(dbcmd, "@WorkStatus", DbType.String, SC_User_TmpRow.WorkStatus.Value)
            If SC_User_TmpRow.BusinessFlag.Updated Then db.AddInParameter(dbcmd, "@BusinessFlag", DbType.String, SC_User_TmpRow.BusinessFlag.Value)
            If SC_User_TmpRow.CompID.Updated Then db.AddInParameter(dbcmd, "@CompID", DbType.String, SC_User_TmpRow.CompID.Value)
            If SC_User_TmpRow.CompName.Updated Then db.AddInParameter(dbcmd, "@CompName", DbType.String, SC_User_TmpRow.CompName.Value)
            If SC_User_TmpRow.DeptID.Updated Then db.AddInParameter(dbcmd, "@DeptID", DbType.String, SC_User_TmpRow.DeptID.Value)
            If SC_User_TmpRow.OrganID.Updated Then db.AddInParameter(dbcmd, "@OrganID", DbType.String, SC_User_TmpRow.OrganID.Value)
            If SC_User_TmpRow.BusinessID.Updated Then db.AddInParameter(dbcmd, "@BusinessID", DbType.String, SC_User_TmpRow.BusinessID.Value)
            If SC_User_TmpRow.WorkTypeID.Updated Then db.AddInParameter(dbcmd, "@WorkTypeID", DbType.String, SC_User_TmpRow.WorkTypeID.Value)
            If SC_User_TmpRow.WorkType.Updated Then db.AddInParameter(dbcmd, "@WorkType", DbType.String, SC_User_TmpRow.WorkType.Value)
            If SC_User_TmpRow.SecWorkTypeID.Updated Then db.AddInParameter(dbcmd, "@SecWorkTypeID", DbType.String, SC_User_TmpRow.SecWorkTypeID.Value)
            If SC_User_TmpRow.SecWorkType.Updated Then db.AddInParameter(dbcmd, "@SecWorkType", DbType.String, SC_User_TmpRow.SecWorkType.Value)
            If SC_User_TmpRow.RankID.Updated Then db.AddInParameter(dbcmd, "@RankID", DbType.String, SC_User_TmpRow.RankID.Value)
            If SC_User_TmpRow.TitleName.Updated Then db.AddInParameter(dbcmd, "@TitleName", DbType.String, SC_User_TmpRow.TitleName.Value)
            If SC_User_TmpRow.Password.Updated Then db.AddInParameter(dbcmd, "@Password", DbType.String, SC_User_TmpRow.Password.Value)
            If SC_User_TmpRow.PasswordErrorCount.Updated Then db.AddInParameter(dbcmd, "@PasswordErrorCount", DbType.Int32, SC_User_TmpRow.PasswordErrorCount.Value)
            If SC_User_TmpRow.ExpireDate.Updated Then db.AddInParameter(dbcmd, "@ExpireDate", DbType.Date, IIf(IsDateTimeNull(SC_User_TmpRow.ExpireDate.Value), DBNull.Value, SC_User_TmpRow.ExpireDate.Value))
            If SC_User_TmpRow.EMail.Updated Then db.AddInParameter(dbcmd, "@EMail", DbType.String, SC_User_TmpRow.EMail.Value)
            If SC_User_TmpRow.BanMark.Updated Then db.AddInParameter(dbcmd, "@BanMark", DbType.String, SC_User_TmpRow.BanMark.Value)
            If SC_User_TmpRow.LastLoginDate.Updated Then db.AddInParameter(dbcmd, "@LastLoginDate", DbType.Date, IIf(IsDateTimeNull(SC_User_TmpRow.LastLoginDate.Value), DBNull.Value, SC_User_TmpRow.LastLoginDate.Value))
            If SC_User_TmpRow.HostName.Updated Then db.AddInParameter(dbcmd, "@HostName", DbType.String, SC_User_TmpRow.HostName.Value)
            If SC_User_TmpRow.UpdateFlag.Updated Then db.AddInParameter(dbcmd, "@UpdateFlag", DbType.String, SC_User_TmpRow.UpdateFlag.Value)
            If SC_User_TmpRow.CreateDate.Updated Then db.AddInParameter(dbcmd, "@CreateDate", DbType.Date, IIf(IsDateTimeNull(SC_User_TmpRow.CreateDate.Value), DBNull.Value, SC_User_TmpRow.CreateDate.Value))
            If SC_User_TmpRow.LastChgID.Updated Then db.AddInParameter(dbcmd, "@LastChgID", DbType.String, SC_User_TmpRow.LastChgID.Value)
            If SC_User_TmpRow.LastChgDate.Updated Then db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(SC_User_TmpRow.LastChgDate.Value), DBNull.Value, SC_User_TmpRow.LastChgDate.Value))
            db.AddInParameter(dbcmd, "@PKUserID", DbType.String, IIf(SC_User_TmpRow.LoadFromDataRow, SC_User_TmpRow.UserID.OldValue, SC_User_TmpRow.UserID.Value))

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Update(ByVal SC_User_TmpRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim strDot As String = String.Empty
            ...
            Using cn As DbConnection = db.CreateConnection()
                ...
                Try
                    For Each r As Row In SC_User_TmpRow
                        ...
                        If r.ExpireDate.Updated Then db.AddInParameter(dbcmd, "@ExpireDate", DbType.Date, IIf(IsDateTimeNull(r.ExpireDate.Value), DBNull.Value, r.ExpireDate.Value))
                        ...
                        If r.LastLoginDate.Updated Then db.AddInParameter(dbcmd, "@LastLoginDate", DbType.Date, IIf(IsDateTimeNull(r.LastLoginDate.Value), DBNull.Value, r.LastLoginDate.Value))
        ...
        Public Function IsDataExists(ByVal SC_User_TmpRow As Row) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0

            strSQL.AppendLine("Select Count(*) Cnt From SC_User_Tmp")
            strSQL.AppendLine("Where UserID = @UserID")
        ...
        Public Function IsDataExists(ByVal SC_User_TmpRow As Row, ByVal tran As DbTransaction) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intCount As Integer = 0
        ...
        Public Function Insert(ByVal SC_User_TmpRow As Row) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()

            strSQL.AppendLine("Insert into SC_User_Tmp")
            strSQL.AppendLine("(")
            strSQL.AppendLine("    UserID, UserName, EngName, WorkStatus, BusinessFlag, CompID, CompName, DeptID, OrganID,")
            strSQL.AppendLine("    BusinessID, WorkTypeID, WorkType, SecWorkTypeID, SecWorkType, RankID, TitleName, Password,")
            strSQL.AppendLine("    PasswordErrorCount, ExpireDate, EMail, BanMark, LastLoginDate, HostName, UpdateFlag,")
            ...
            dbcmd = db.GetSqlStringCommand(strSQL.ToString())
            db.AddInParameter(dbcmd, "@UserID", DbType.String, SC_User_TmpRow.UserID.Value)
            db.AddInParameter(dbcmd, "@UserName", DbType.String, SC_User_TmpRow.UserName.Value)
            db.AddInParameter(dbcmd, "@EngName", DbType.String, SC_User_TmpRow.EngName.Value)
            db.AddInParameter(dbcmd, "@WorkStatus", DbType.String, SC_User_TmpRow.WorkStatus.Value)
            db.AddInParameter(dbcmd, "@BusinessFlag", DbType.String, SC_User_TmpRow.BusinessFlag.Value)
            db.AddInParameter(dbcmd, "@CompID", DbType.String, SC_User_TmpRow.CompID.Value)
            db.AddInParameter(dbcmd, "@CompName", DbType.String, SC_User_TmpRow.CompName.Value)
            db.AddInParameter(dbcmd, "@DeptID", DbType.String, SC_User_TmpRow.DeptID.Value)
            db.AddInParameter(dbcmd, "@OrganID", DbType.String, SC_User_TmpRow.OrganID.Value)
            db.AddInParameter(dbcmd, "@BusinessID", DbType.String, SC_User_TmpRow.BusinessID.Value)
            db.AddInParameter(dbcmd, "@WorkTypeID", DbType.String, SC_User_TmpRow.WorkTypeID.Value)
            db.AddInParameter(dbcmd, "@WorkType", DbType.String, SC_User_TmpRow.WorkType.Value)
            db.AddInParameter(dbcmd, "@SecWorkTypeID", DbType.String, SC_User_TmpRow.SecWorkTypeID.Value)
            db.AddInParameter(dbcmd, "@SecWorkType", DbType.String, SC_User_TmpRow.SecWorkType.Value)
            db.AddInParameter(dbcmd, "@RankID", DbType.String, SC_User_TmpRow.RankID.Value)
            db.AddInParameter(dbcmd, "@TitleName", DbType.String, SC_User_TmpRow.TitleName.Value)
            db.AddInParameter(dbcmd, "@Password", DbType.String, SC_User_TmpRow.Password.Value)
            db.AddInParameter(dbcmd, "@PasswordErrorCount", DbType.Int32, SC_User_TmpRow.PasswordErrorCount.Value)
            db.AddInParameter(dbcmd, "@ExpireDate", DbType.Date, IIf(IsDateTimeNull(SC_User_TmpRow.ExpireDate.Value), DBNull.Value, SC_User_TmpRow.ExpireDate.Value))
            db.AddInParameter(dbcmd, "@EMail", DbType.String, SC_User_TmpRow.EMail.Value)
            db.AddInParameter(dbcmd, "@BanMark", DbType.String, SC_User_TmpRow.BanMark.Value)
            db.AddInParameter(dbcmd, "@LastLoginDate", DbType.Date, IIf(IsDateTimeNull(SC_User_TmpRow.LastLoginDate.Value), DBNull.Value, SC_User_TmpRow.LastLoginDate.Value))
            db.AddInParameter(dbcmd, "@HostName", DbType.String, SC_User_TmpRow.HostName.Value)
            db.AddInParameter(dbcmd, "@UpdateFlag", DbType.String, SC_User_TmpRow.UpdateFlag.Value)
            db.AddInParameter(dbcmd, "@CreateDate", DbType.Date, IIf(IsDateTimeNull(SC_User_TmpRow.CreateDate.Value), DBNull.Value, SC_User_TmpRow.CreateDate.Value))
            db.AddInParameter(dbcmd, "@LastChgID", DbType.String, SC_User_TmpRow.LastChgID.Value)
            db.AddInParameter(dbcmd, "@LastChgDate", DbType.Date, IIf(IsDateTimeNull(SC_User_TmpRow.LastChgDate.Value), DBNull.Value, SC_User_TmpRow.LastChgDate.Value))

            Return db.ExecuteNonQuery(dbcmd)
        End Function

        Public Function Insert(ByVal SC_User_TmpRow As Row, ByVal tran As DbTransaction) As Integer
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            ...
            Using cn As DbConnection = db.CreateConnection()
                ...
                Try
                    For Each r As Row In SC_User_TmpRow
                        ...
                        db.AddInParameter(dbcmd, "@ExpireDate", DbType.Date, IIf(IsDateTimeNull(r.ExpireDate.Value), DBNull.Value, r.ExpireDate.Value))
                        db.AddInParameter(dbcmd, "@EMail", DbType.String, r.EMail.Value)
                        db.AddInParameter(dbcmd, "@BanMark", DbType.String, r.BanMark.Value)
                        db.AddInParameter(dbcmd, "@LastLoginDate", DbType.Date, IIf(IsDateTimeNull(r.LastLoginDate.Value), DBNull.Value, r.LastLoginDate.Value))
        ...
        Public Function Insert(ByVal SC_User_TmpRow As Row(), ByVal tran As DbTransaction) As Boolean
            Dim db As Database = DatabaseFactory.CreateDatabase()
            Dim dbcmd As DbCommand
            Dim strSQL As StringBuilder = New StringBuilder()
            Dim intRowsAffected As Integer = 0
