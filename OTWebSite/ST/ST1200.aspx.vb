...
Partial Class ST_ST1200
    ...
    Private Sub DoAdd()
        ...
        Me.TransferFramePage("~/ST/ST1201.aspx", New ButtonState() {btnA, btnX, btnC}, _
            ...
            "SelectedActionID=" & ViewState.Item("ActionID"), _
    ...
    Private Sub DoUpdate()
        ...
        Me.TransferFramePage("~/ST/ST1202.aspx", New ButtonState() {btnU, btnX, btnC}, _
            lblCompRoleID.ID & "=" & ViewState.Item("CompID"), _
            txtEmpID.ID & "=" & txtEmpID.Text, _
            txtEmpName.ID & "=" & txtEmpName.Text, _
            "SelectedCompID=" & ViewState.Item("CompID"), _
            ...
            "SelectedActionID=" & gvMain.DataKeys(Me.selectedRow(gvMain))("ActionID").ToString(), _
            "SelectedActionName=" & gvMain.DataKeys(Me.selectedRow(gvMain))("ActionName").ToString(), _
            "PageNo=" & pcMain.PageNo.ToString(), _
            "DoQuery=" & Bsp.Utility.IsStringNull(ViewState.Item("DoQuery")))
    End Sub
    ...
    Private Sub DoQuery()
        ...
        Try
            pcMain.DataTable = objST.QueryEmpFlowSetting(
    ...
    Private Sub DoDelete()
        ...
        Else
            ...
            beEmpFlow.CompID.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("CompID").ToString()
            beEmpFlow.EmpID.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("EmpID").ToString()
            beEmpFlow.ActionID.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("ActionID").ToString()

            Try
                objST.DeleteEmpFlowSetting(beEmpFlow)
            Catch ex As Exception
    ...
    Protected Sub gvMain_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvMain.RowCommand
        If e.CommandName = "Detail" Then
            ...
            Me.TransferFramePage("~/ST/ST1202.aspx", New ButtonState() {btnX}, _
                lblCompRoleID.ID & "=" & ViewState.Item("CompID"), _
                txtEmpID.ID & "=" & txtEmpID.Text, _
                txtEmpName.ID & "=" & txtEmpName.Text, _
                "SelectedCompID=" & ViewState.Item("CompID"), _
