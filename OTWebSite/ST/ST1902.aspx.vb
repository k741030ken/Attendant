...
Partial Class ST_ST1902
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack() Then
            ST1.FillDDL(ddlNotEmpReasonID, "EmployeeReason ", "Rtrim(Reason)", "Rtrim(Remark)", ST1.DisplayType.Full, " AND NotEmpLogFlag='1' ", "", "")
    ...
    Private Function SaveData() As Boolean
        ...
        Try
            Return objST.UpdateNotEmpLogSetting(beNotEmpLog)
    ...
    Private Sub subGetData(ByVal CompID As String, ByVal EmpID As String, ByVal Seq As String)
        ...
        Try
            Using dt As DataTable = bsNotEmpLog.QueryByKey(beNotEmpLog).Tables(0)
                ...
                '中斷原因
                ddlNotEmpReasonID.SelectedValue = beNotEmpLog.NotEmpReasonID.Value
