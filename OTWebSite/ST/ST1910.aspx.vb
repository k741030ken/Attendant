...
Partial Class ST_ST1910
    ...
    Private Sub DoAdd()
        ...
        Me.TransferFramePage("~/ST/ST1911.aspx", New ButtonState() {btnA, btnX, btnC}, _
    ...
    Private Sub DoUpdate()
        ...
        Me.TransferFramePage("~/ST/ST1912.aspx", New ButtonState() {btnU, btnX, btnC}, _
            "SelectedCompID=" & ViewState.Item("CompID"), _
            "SelectedCompName=" & ViewState.Item("CompName"), _
            "SelectedEmpID=" & ViewState.Item("EmpID"), _
            "SelectedEmpName=" & ViewState.Item("EmpName"), _
    ...
    Private Sub DoQuery()
        ...
        Try
            If UserProfile.SelectCompRoleID = "ALL" Then
                ...
                pcMain.DataTable = objST.QueryNotEmpLog_SPHOLD(
            ...
            Else
                Using dt As DataTable = objST.QueryNotEmpLogInfo(
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        txtTotSen_SPHOLD1.Text = dt.Rows(0).Item("TotSen_SPHOLD1").ToString
                        txtTotSen_SPHOLD2.Text = dt.Rows(0).Item("TotSen_SPHOLD2").ToString
                        txtTotDays_SPHOLD1.Text = dt.Rows(0).Item("Days_SPHOLD") + dt.Rows(0).Item("TotDays_SPHOLD1")
                        txtTotDays_SPHOLD2.Text = dt.Rows(0).Item("Days_SPHOLD") + dt.Rows(0).Item("TotDays_SPHOLD2")
                        txtSen_SPHOLD1.Text = objST.QueryNotEmpSen(ViewState.Item("IDNo"), ViewState.Item("CompID"), True, "1")
                        txtSen_SPHOLD2.Text = objST.QueryNotEmpSen(ViewState.Item("IDNo"), ViewState.Item("CompID"), True, "2")
                        txtDays_SPHOLD1.Text = dt.Rows(0).Item("TotDays_SPHOLD1").ToString
                        txtDays_SPHOLD2.Text = dt.Rows(0).Item("TotDays_SPHOLD2").ToString
                    End If
                End Using
    ...
    Private Sub DoDelete()
        ...
        Else
            ...
            beNotEmpLog.ValidDateB.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("ValidDateBB").ToString()
            beNotEmpLog.ValidDateE.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("ValidDateEE").ToString()

            Try
                objST.DeleteNotEmpLog_SPHOLD(beNotEmpLog)
            Catch ex As Exception
    ...
    Protected Sub gvMain_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvMain.RowCommand
        If e.CommandName = "Detail" Then
            ...
            Me.TransferFramePage("~/ST/ST1912.aspx", New ButtonState() {btnX}, _
                "SelectedCompID=" & ViewState.Item("CompID"), _
                "SelectedCompName=" & ViewState.Item("CompName"), _
                "SelectedEmpID=" & ViewState.Item("EmpID"), _
                "SelectedEmpName=" & ViewState.Item("EmpName"), _
