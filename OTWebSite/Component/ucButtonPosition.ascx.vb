...
Partial Class Component_ucButtonPosition
    ...
    Public Property QueryOrganID() As String
        ...
        End Set
    End Property
    Public Property DefaultPosition() As String
        Get
            If ViewState.Item("DefaultPosition") Is Nothing Then
                ViewState.Item("DefaultPosition") = ""
            End If
            Return ViewState.Item("DefaultPosition")
        End Get
        Set(ByVal value As String)
            ViewState.Item("DefaultPosition") = value
        End Set
    End Property
    ...
    Private Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
        ...
        strUrl = ResolveUrl("PagePosition.aspx")
    ...
    Public Sub OpenSelect()
        ...
        Dim strControlSessionID As String = "ButtonPosition_" & Now.ToString("HHmmss") & Now.Millisecond.ToString("000")
        ViewState.Item("ControlSessionID") = strControlSessionID

        Dim aryParam(6) As Object
        aryParam(0) = QueryCompID
        aryParam(1) = QueryEmpID
        aryParam(2) = DefaultPosition
        aryParam(3) = Fields
