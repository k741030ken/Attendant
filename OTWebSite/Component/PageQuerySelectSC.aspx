<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PageQuerySelectSC.aspx.vb" Inherits="Component_PageQuerySelectSC" EnableEventValidation="false" %>
        ...
        <table width="100%" border="0">
            ...
            <tr>
                <td align="center" style="padding-top: 30px;">
                    <asp:GridView ID="gvMain" runat="server" Width="100%" Font-Size="12px" CssClass="GridViewStyle" HeaderStyle-CssClass="td_header" RowStyle-CssClass="td_detail" AllowPaging="true" AutoGenerateColumns="False" PageSize="12" DataKeyNames="CompID,CompName,UserID,UserName">
                        <Columns>
                            <asp:TemplateField>
                            ...
                            <asp:BoundField HeaderStyle-Width="10%" HeaderText="員工姓名" DataField="UserName" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField HeaderStyle-Width="10%" HeaderText="員工編號" DataField="UserID" ItemStyle-HorizontalAlign="Center" />
