<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PageQuerySelect.aspx.vb" Inherits="Component_PageQuerySelect" %>
...
<body style="margin-top:5px; margin-left:10px; margin-right:10px; margin-bottom:5px" >
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="center">
                    <asp:GridView Font-Size="12px" Font-Names="Microsoft Sans Serif"  cssclass="GridViewStyle" HeaderStyle-CssClass="td_header" RowStyle-CssClass="td_detail" AllowPaging="true" PageSize="12" runat="server" ID="gvMain" width="100%" AutoGenerateColumns="false" >
                        <Columns>
                            <asp:TemplateField>
