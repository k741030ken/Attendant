...
Partial Class Component_PageQuerySelect
    Inherits PageBase
    ...
    Private Sub LoadField(ByVal SQL As String)
        ...
        Using dt As DataTable = Bsp.DB.ExecuteDataSet(CommandType.Text, SQL).Tables(0)
    ...
    Protected Sub LoadData()
        ...
        If txtQueryString.Text.Trim().Length > 0 Then
            strsQL = "Select Top 200 * From ( " & strsQL & " ) a  where [" & ddlField.SelectedValue & "] like " & Bsp.Utility.Quote("%" & txtQueryString.Text.Trim() & "%") & " " & ViewState.Item("QuerySQL_Order").ToString()
        Else
