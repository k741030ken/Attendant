<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PagePosition.aspx.vb" Inherits="Component_PagePosition" EnableEventValidation="false" %>
...
<body style="margin-top:5px; margin-left:10px; margin-right:10px; margin-bottom:5px" >
    ...
    <font style="font-size:12px; color: #FF0000">※已選第一筆職位，為主要職位</font>
    <table id="table1" class="tbl_Content" border="0" style="width:100%; height:100%; font-size:12px;font-family: 細明體;"  >
	    <tr  valign="middle" >
		    <td  style="width:45%" align="center" >
		        <asp:label id="lblLeftCaption" runat="server" ForeColor="blue" Text="未選職位"></asp:label>
		    </td>
		    <td  style="width:5%">&nbsp;</td>
		    <td  style="width:45%" align="center" >
		        <asp:label id="lblRightCaption" runat="server" ForeColor="blue" Text="已選職位"></asp:label>
		    </td>
		    <td  style="width:5%">&nbsp;</td>
	    </tr>
	    <tr>
