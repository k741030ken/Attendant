...
Partial Class Component_ucButtonQuerySelectUserID
    ...
    '20160225 Beatrice Add 是否為安控資料庫
    Public Property ConnType() As String
        Get
            If ViewState.Item("ConnType") Is Nothing Then
                ViewState.Item("ConnType") = ""
            End If
            Return ViewState.Item("ConnType")
        End Get
        Set(ByVal value As String)
            ViewState.Item("ConnType") = value
            If value = "SC" Then
                btnSelect.Attributes.Add("style", "background-image:url('../images/title_bg.gif')")
            End If
        End Set
    End Property
    ...
    Private Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
        ...
        Select Case SelectStyle
            ...
            Case Bsp.Enums.SelectStyle.RadioButton
                strUrl = ResolveUrl("PageQuerySelectUserID.aspx")
                strUrl = strUrl & "?ControlSessionID=" & ViewState.Item("ControlSessionID")
                txtParam.Text = "?FunID=QFind&Path=" & strUrl
        End Select

        If ConnType = "SC" Then
            strUrl = ResolveUrl("PageQuerySelectSC.aspx")
            strUrl = strUrl & "?ControlSessionID=" & ViewState.Item("ControlSessionID")
            txtParam.Text = "?FunID=QFind&Path=" & strUrl
        End If
    ...
    Public Sub OpenSelect()
        ...
        ElseIf ShowCompRole.ToString.Length = 0 Then
            Bsp.Utility.ShowFormatMessage(Me.Page, "W_00100", "ShowCompRole")
        Else
            Dim strControlSessionID As String = "ButtonQuerySelectUserID_" & Now.ToString("HHmmss") & Now.Millisecond.ToString("000")
