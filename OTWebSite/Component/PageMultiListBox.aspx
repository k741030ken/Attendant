<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PageMultiListBox.aspx.vb" Inherits="Component_PageMultiListBox" EnableEventValidation="false" %>
        ...
        <table id="table1" class="tbl_Content" border="0" style="width:100%; height:100%; font-size:12px;font-family: 細明體;">
	        ...
	        <tr>
		        ...
		        <td  style="width:5%" align="center">
		            <p><asp:imagebutton id="btnMoveRight" runat="server" ImageUrl="../images/Next.gif" CausesValidation="False"></asp:imagebutton></p>
		        ...
		        <td  style="width:5%" align="center">
		            <p><asp:imagebutton id="btnMoveUp" runat="server" ImageUrl="../images/btnUp.gif" CausesValidation="False"></asp:imagebutton></p>
