<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ATWF11.aspx.vb" Inherits="ATWF_ATWF11" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html >
<html>
<head id="Head1" runat="server">
    <title>流程適用人員設定(新增)</title>
    <style type="text/css">
        .GridViewStyle
        {
            font-size: 15px;
...
//        }
        function BtnClick() {
            var btn = document.getElementById("ValidDateB")
            btn.click();
        }
...
<asp:DropDownList ID="ddlFlowCode" runat="server" Font-Names="微軟正黑體" AutoPostBack="true" OnSelectedIndexChanged = "ddlFlowCode_SelectedIndexChanged">
            ...
            <td width="40%" class="style2">
                <asp:DropDownList ID="ddlFlowSN" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr id="BusinessType" runat="server" Visible="false">
            ...
            <td width="10%" align="left" class="style1" >
                <asp:Label ID="lblEmpFlowRemark" Visible="false" runat="server" Text="適用功能備註" Font-Names="微軟正黑體"></asp:Label>
            </td>
            <td width="40%" align="left" class="style2" >
