<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PA1400.aspx.vb" Inherits="PA_PA1400" %>
                ...
                <td align="center" style="height: 30px;">
                    <table cellpadding="1" cellspacing="1" border="0" class="tbl_Condition" height="100%" width="100%">
                        <tr>
                            ...
                            <td align="left" width="10%">
                                <asp:Label ID="Label1" Font-Size="15px" runat="server" Text="職稱代碼："></asp:Label>
                            </td>
                            <td align="left" width="15%">
                                <asp:UpdatePanel ID="UpdTitleID" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlTitleID" runat="server" Font-Names="細明體"></asp:DropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            <td width="10%"></td>
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="RankID,CompID,TitleID" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TitleID" HeaderText="職稱代碼" ReadOnly="True" SortExpression="TitleID" >
                                            <HeaderStyle Width="5%" CssClass="td_header" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="TitleName" HeaderText="職稱名稱" ReadOnly="True" SortExpression="TitleName" >
                                            <HeaderStyle Width="10%" CssClass="td_header" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="TitleEngName" HeaderText="職稱英文名稱" ReadOnly="True" SortExpression="TitleEngName" >
