<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PA1700.aspx.vb" Inherits="PA_PA1700" %>
                ...
                <td align="center" style="height: 30px;">
                    <table cellpadding="1" cellspacing="1" border="0" class="tbl_Condition" height="100%" width="100%">
                        ...
                        <tr>
                            <td width="3%"></td>
                            <td align="left" width="10%">
                                <asp:Label ID="lblWorkTypeID" Font-Size="15px" runat="server" Text="工作性質代碼："></asp:Label>
                            </td>
                            <td align="left" width="15%">
                                <asp:UpdatePanel ID="UpdWorkTypeID" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlWorkTypeID" AutoPostBack="true" runat="server" Font-Names="細明體"></asp:DropDownList>
                                    </ContentTemplate>                                                          
                                    <Triggers>
                            ...
                            <td align="left" width="10%">
                                <asp:Label ID="lblRemark" Font-Size="15px" runat="server" Text="工作性質名稱："></asp:Label>
                            </td>
                            <td align="left" width="15%">
                        ...
                        <tr>
                            ...
                            <td align="left" width="10%">
                                <asp:Label ID="lblPBFlag" Font-Size="15px" runat="server" Text="PB類："></asp:Label>
                            </td>
                            <td align="left" width="15%">
                                <asp:UpdatePanel ID="UpdPBFlag" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlPBFlag" AutoPostBack="true" runat="server" Font-Names="細明體"></asp:DropDownList>
                                    </ContentTemplate>                                                          
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="ddlCompID" />
                                    </Triggers>
                            ...
                            <td align="left" width="10%">
                                <asp:Label ID="lblAOFlag" Font-Size="15px" runat="server" Text="AO/OP："></asp:Label>
                            </td>
                            <td align="left" width="15%">
                                <asp:UpdatePanel ID="UpdAOFlag" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlAOFlag" AutoPostBack="true" runat="server" Font-Names="細明體"></asp:DropDownList>
                                    </ContentTemplate>                                                          
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="ddlCompID" />
                                    </Triggers>
                        ...
                        <tr>
                            ...
                            <td align="left" width="15%">
                                <asp:UpdatePanel ID="UpdOrganPrintFlag" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlOrganPrintFlag" AutoPostBack="true" runat="server" Font-Names="細明體"></asp:DropDownList>
                                    </ContentTemplate>                                                          
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="ddlCompID" />
                                    </Triggers>
                            ...
                            <td align="left" width="10%">
                                <asp:Label ID="lblClass" Font-Size="15px" runat="server" Text="工作性質類別："></asp:Label>
                            </td>
                            <td align="left" width="15%">
                                <asp:UpdatePanel ID="UpdClass" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlClass" AutoPostBack="true" runat="server" Font-Names="細明體"></asp:DropDownList>
                                    </ContentTemplate>                                                          
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="ddlCompID" />
                                    </Triggers>
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="WorkTypeID" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Remark" HeaderText="工作性質名稱" ReadOnly="True" SortExpression="Remark" >
                                            <HeaderStyle Width="8%" CssClass="td_header" />
                                        ...
                                        <asp:BoundField DataField="AOFlag" HeaderText="AO/OP" ReadOnly="True" SortExpression="AOFlag" >
                                            <HeaderStyle Width="5%" CssClass="td_header" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="PB類" SortExpression="PBFlag">
                                            <ItemStyle CssClass="td_detail" />
                                            <HeaderStyle CssClass="td_header" Width="4%" />
                                            <ItemTemplate>
                                                <asp:Image ID="imgPBFlag" runat="server" ImageUrl="~/Images/chkbox.gif" Visible='<% # Iif(DataBinder.Eval(Container.DataItem, "PBFlag")="1","True","False") %>' />
                                                <asp:Image ID="imgPBFlag1" runat="server" ImageUrl="~/Images/chkboxE.gif" Visible='<% # Iif(DataBinder.Eval(Container.DataItem, "PBFlag")="1","False","True") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="Class" HeaderText="工作性質類別" ReadOnly="True" SortExpression="Class" >
