<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PA1600.aspx.vb" Inherits="PA_PA1600" %>
                ...
                <td align="center" style="height: 30px;">
                    <table cellpadding="1" cellspacing="1" border="0" class="tbl_Condition" height="100%" width="100%">
                        <tr>
                            ...
                            <td align="left" width="10%">
                                <asp:Label ID="lblRankID" Font-Size="15px" runat="server" Text="公司職等："></asp:Label>
                            </td>
                            <td align="left" width="15%">
                            ...
                            <td width="10%"></td>
                            <td align="left" width="10%">
                                <asp:Label ID="lblRankIDMap" Font-Size="15px" runat="server" Text="比對職等："></asp:Label>
                            </td>
                            <td align="left" width="15%">
                                <asp:UpdatePanel ID="UpdRankIDMap" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlRankIDMap" AutoPostBack="true" runat="server" Font-Names="細明體"></asp:DropDownList>
                                    </ContentTemplate>
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="ddlCompID" />
                                    </Triggers>
                        ...
                        <tr>
                            <td width="3%"></td>
                            <td align="left" width="10%" colspan="7">
                                <asp:Label ID="Label1" Font-Size="15px" runat="server" ForeColor="Red" Text="※若公司未導入惠悅專案(文字職等)，則【公司職等】與【對照職等】一致"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="CompID,RankID,RankIDMap" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="RankID" HeaderText="公司職等" ReadOnly="True" SortExpression="RankID" >
                                            <HeaderStyle Width="7%" CssClass="td_header" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="RankIDMap" HeaderText="比對職等" ReadOnly="True" SortExpression="RankIDMap" >
                                            <HeaderStyle Width="5%" CssClass="td_header" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Left" />
                                        </asp:BoundField>                 
