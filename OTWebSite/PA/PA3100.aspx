<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PA3100.aspx.vb" Inherits="PA_PA3100" %>
                ...
                <td align="center" style="height: 30px;">
                    <table cellpadding="1" cellspacing="1" border="0" class="tbl_Condition" height="100%" width="100%">
                        <tr>
                            <td width="10%"></td>
                            <td align="left">
                                <asp:Label ID="lblEduID" Font-Size="15px" runat="server" Text="學歷代碼："></asp:Label>
                            </td>
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="EduID" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="EduID" HeaderText="學歷代碼" ReadOnly="True" SortExpression="EduID" >
                                            <HeaderStyle Width="10%" CssClass="td_header" />
                                            <ItemStyle CssClass="td_detail" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="EduName" HeaderText="學歷名稱" ReadOnly="True" SortExpression="EduName" >
                                            <HeaderStyle Width="20%" CssClass="td_header" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="EduNameCN" HeaderText="學歷名稱(簡)" ReadOnly="True" SortExpression="EduNameCN" >
                                            <HeaderStyle Width="20%" CssClass="td_header" />
                                            <ItemStyle CssClass="td_detail" HorizontalAlign="Left" />
                                        </asp:BoundField>
