<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PA2200.aspx.vb" Inherits="PA_PA2200" %>
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="CompID,OrganID,DeptID,WTID" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
