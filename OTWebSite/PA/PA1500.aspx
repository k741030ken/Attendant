<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PA1500.aspx.vb" Inherits="PA_PA1500" %>
                ...
                <td align="center" style="height: 30px;">
                    <table cellpadding="1" cellspacing="1" border="0" class="tbl_Condition" height="100%" width="100%">
                        <tr>
                            ...
                            <td align="left" width="10%">
                                <asp:Label ID="lblHoldingRankID" Font-Size="15px" runat="server" Text="金控職等："></asp:Label>
                            </td>
                            <td align="left" width="15%">                                
                                <asp:DropDownList ID="ddlHoldingRankID" runat="server" Font-Names="細明體"></asp:DropDownList>
                            </td>
                            <td width="10%"></td>
                        </tr>
                    </table>
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="RankID,CompID,HoldingRankID" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
