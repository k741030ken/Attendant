...
Partial Class PA_PA1710
    ...
    Private Sub DoAdd()
        ...
        Me.TransferFramePage("~/PA/PA1711.aspx", New ButtonState() {btnA, btnX, btnC}, _
    ...
    Private Sub DoUpdate()
        ...
        Me.TransferFramePage("~/PA/PA1712.aspx", New ButtonState() {btnU, btnX, btnC}, _
            ddlCategoryI.ID & "=" & ddlCategoryI.SelectedValue, _
            txtCategoryIName.ID & "=" & txtCategoryIName.Text, _
            "PageNo=" & pcMain.PageNo.ToString(), _
            "SysID=" & arySysID(0), _
    ...
    Private Sub DoQuery()
        ...
        Try
            pcMain.DataTable = objPA.WorkType_CategoryIQuery(
    ...
    Private Sub DoDelete()
        ...
        Else
            ...
            beWorkType_CategoryI.CategoryI.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryI").ToString()

            table = objPA.IsDataExists_WorkType_CategoryII(gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryI").ToString())
            If table.Rows.Count > 0 Then
                Dim Count As String = table.Rows(0).Item(0).ToString()
                If (CInt(Count) > 0) Then
                    Bsp.Utility.ShowFormatMessage(Me, "H_00000", "「" + gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryI").ToString() + "」已存在工作性質檔_中類，不可刪除")
                Else
                    Try
                        objPA.DeleteWorkType_CategoryI(beWorkType_CategoryI)
                    Catch ex As Exception
    ...
    Protected Sub gvMain_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvMain.RowCommand
        If e.CommandName = "Detail" Then
            ...
            Me.TransferFramePage("~/PA/PA1712.aspx", New ButtonState() {btnX}, _
                ddlCategoryI.ID & "=" & ddlCategoryI.SelectedValue, _
                txtCategoryIName.ID & "=" & txtCategoryIName.Text, _
                "PageNo=" & pcMain.PageNo.ToString(), _
                "SelectedCategoryI=" & gvMain.DataKeys(selectedRow(gvMain))("CategoryI").ToString(), _
