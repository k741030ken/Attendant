...
Partial Class PA_PA1730
    ...
    Private Sub DoAdd()
        ...
        Me.TransferFramePage("~/PA/PA1731.aspx", New ButtonState() {btnA, btnX, btnC}, _
    ...
    Private Sub DoUpdate()
        ...
        Me.TransferFramePage("~/PA/PA1732.aspx", New ButtonState() {btnU, btnX, btnC}, _
            ddlCategoryIII.ID & "=" & ddlCategoryIII.SelectedValue, _
            txtCategoryIIIName.ID & "=" & txtCategoryIIIName.Text, _
            "PageNo=" & pcMain.PageNo.ToString(), _
            "SysID=" & arySysID(0), _
    ...
    Private Sub DoQuery()
        ...
        Try
            pcMain.DataTable = objPA.WorkType_CategoryIIIQuery(
    ...
    Private Sub DoDelete()
        ...
        Else
            ...
            beWorkType_CategoryIII.CategoryI.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryI").ToString()
            beWorkType_CategoryIII.CategoryII.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryII").ToString()
            beWorkType_CategoryIII.CategoryIII.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryIII").ToString()

            Try
                objPA.DeleteWorkType_CategoryIII(beWorkType_CategoryIII)
            Catch ex As Exception
    ...
    Protected Sub gvMain_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvMain.RowCommand
        If e.CommandName = "Detail" Then
            ...
            Me.TransferFramePage("~/PA/PA1732.aspx", New ButtonState() {btnX}, _
                ddlCategoryIII.ID & "=" & ddlCategoryIII.SelectedValue, _
                txtCategoryIIIName.ID & "=" & txtCategoryIIIName.Text, _
                "PageNo=" & pcMain.PageNo.ToString(), _
                "SelectedCategoryI=" & gvMain.DataKeys(selectedRow(gvMain))("CategoryI").ToString(), _
