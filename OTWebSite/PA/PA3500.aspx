<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PA3500.aspx.vb" Inherits="PA_PA3500" %>
                    ...
                    <table cellpadding="1" cellspacing="1" border="0" class="tbl_Condition" height="100%" width="100%">
                        <tr>
                            ...
                            <td align="left" width="15%">
                                <asp:Label ID="lblDepartID" Font-Size="15px" runat="server" Text="科系代碼："></asp:Label>
                            </td>
                            <td align="left" width="45%">
                                <asp:DropDownList ID="ddlDepartID" runat="server" Font-Names="細明體"></asp:DropDownList>
                            </td>
                            <td align="left" width="10%">
                                <asp:Label ID="lblRemark" Font-Size="15px" runat="server" Text="科系名稱："></asp:Label>
                            </td>
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="DepartID" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DepartID" HeaderText="科系代碼" ReadOnly="True" SortExpression="DepartID" >
                                            <HeaderStyle Width="10%" CssClass="td_header" />
                                            <ItemStyle CssClass="td_detail" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Remark" HeaderText="科系名稱" ReadOnly="True" SortExpression="Remark" >
