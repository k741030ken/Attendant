...
Partial Class PA_PA1820
    ...
    Private Sub DoAdd()
        ...
        Me.TransferFramePage("~/PA/PA1821.aspx", New ButtonState() {btnA, btnX, btnC}, _
    ...
    Private Sub DoUpdate()
        ...
        Me.TransferFramePage("~/PA/PA1822.aspx", New ButtonState() {btnU, btnX, btnC}, _
            ddlCategoryII.ID & "=" & ddlCategoryII.SelectedValue, _
            txtCategoryIIName.ID & "=" & txtCategoryIIName.Text, _
            "PageNo=" & pcMain.PageNo.ToString(), _
            "SysID=" & arySysID(0), _
    ...
    Private Sub DoQuery()
        ...
        Try
            pcMain.DataTable = objPA.Position_CategoryIIQuery(
    ...
    Private Sub DoDelete()
        ...
        Else
            ...
            bePosition_CategoryII.CategoryI.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryI").ToString()
            bePosition_CategoryII.CategoryII.Value = gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryII").ToString()

            table = objPA.IsDataExists_Position_CategoryIII(gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryI").ToString(), gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryII").ToString())
            If table.Rows.Count > 0 Then
                Dim Count As String = table.Rows(0).Item(0).ToString()
                If (CInt(Count) > 0) Then
                    Bsp.Utility.ShowFormatMessage(Me, "H_00000", "「" + gvMain.DataKeys(Me.selectedRow(gvMain))("CategoryII").ToString() + "」已存在職位_細類檔，不可刪除")
                Else
                    Try
                        objPA.DeletePosition_CategoryII(bePosition_CategoryII)
                    Catch ex As Exception
    ...
    Protected Sub gvMain_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvMain.RowCommand
        If e.CommandName = "Detail" Then
            ...
            Me.TransferFramePage("~/PA/PA1822.aspx", New ButtonState() {btnX}, _
                ddlCategoryII.ID & "=" & ddlCategoryII.SelectedValue, _
                txtCategoryIIName.ID & "=" & txtCategoryIIName.Text, _
                "PageNo=" & pcMain.PageNo.ToString(), _
                "SelectedCategoryI=" & gvMain.DataKeys(selectedRow(gvMain))("CategoryI").ToString(), _
