<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PA1710.aspx.vb" Inherits="PA_PA1710" %>
                    ...
                    <table cellpadding="1" cellspacing="1" border="0" class="tbl_Condition" height="100%" width="100%">
                        <tr>
                            ...
                            <td align="left" class="style1">
                                <asp:Label ID="lblCategoryI" Font-Size="15px" runat="server" Text="大類代碼："></asp:Label>
                            </td>
                            ...
                            <td align="left" class="style2">
                                <asp:Label ID="lblCategoryIName" Font-Size="15px" runat="server" Text="大類名稱："></asp:Label>
                            </td>
                            <td align="left">
                                <asp:TextBox CssClass="InputTextStyle_Thin" ID="txtCategoryIName" runat="server"></asp:TextBox>
                            </td>
                            <td width="10%"></td>
                        </tr>                        
                    </table>
            ...
            <tr>
                <td align="center" width="100%">
                    <table width="100%" height="100%" class="tbl_Content">
                        ...
                        <tr>
                            <td style="width: 100%">
                                <asp:GridView ID="gvMain" runat="server" AllowPaging="False" AllowSorting="true" AutoGenerateColumns="False" CssClass="GridViewStyle" CellPadding="2" DataKeyNames="CategoryI" Width="100%" PageSize="15" HeaderStyle-ForeColor="dimgray">
